...
USaveGameCarrier* UNewGameSaveHolder::getTutorialGameSave(bool full)
{
	...
	auto b_12 = make1(1, 24, -31, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_12, 0.000000); UsedBlocks->Add(b_12);
	auto b_13 = make1(2, 13, -31, 9, 20, 1, 11, 0, 0, 0, 2200.000000, ""); UsedBlocks->Add(b_13);
	auto b_14 = make1(2, 24, -20, 5, 20, 1, 3, 0, -90, 0, 600.000000, ""); UsedBlocks->Add(b_14);
	auto b_15 = make1(2, 24, -20, 13, 20, 1, 3, 0, -90, 0, 600.000000, ""); UsedBlocks->Add(b_15);
	auto b_16 = make1(1, 24, -14, 11, 1, 1, 3, 0, -180, 90, 30.000000, ""); mE(b_16, 0.000000); UsedBlocks->Add(b_16);
	auto b_17 = make1(1, 24, -18, 11, 1, 1, 3, 0, -180, 90, 30.000000, ""); mE(b_17, 0.000000); UsedBlocks->Add(b_17);
	auto b_18 = make1(1, 24, -22, 11, 1, 1, 3, 0, -180, 90, 30.000000, ""); mE(b_18, 0.000000); UsedBlocks->Add(b_18);
	auto b_19 = make1(1, 24, -26, 9, 1, 1, 5, 0, 180, 0, 50.000000, ""); mE(b_19, 0.000000); UsedBlocks->Add(b_19);
	auto b_20 = make1(1, 24, -28, 9, 1, 1, 5, 0, 180, 0, 50.000000, ""); mE(b_20, 0.000000); UsedBlocks->Add(b_20);
	auto b_21 = make1(1, 24, -14, 8, 1, 1, 4, 0, 180, 0, 40.000000, ""); mE(b_21, 0.000000); UsedBlocks->Add(b_21);
	auto b_22 = make1(1, 24, -17, 9, 1, 1, 3, 0, 180, 0, 30.000000, ""); mE(b_22, 0.000000); UsedBlocks->Add(b_22);
	auto b_23 = make1(1, 24, -21, 8, 1, 1, 4, 0, 180, 0, 40.000000, ""); mE(b_23, 0.000000); UsedBlocks->Add(b_23);
	auto b_24 = make1(1, 24, -18, 7, 1, 1, 3, 0, 180, 90, 30.000000, ""); mE(b_24, 0.000000); UsedBlocks->Add(b_24);
	auto b_25 = make1(1, 24, -19, 10, 1, 1, 1, 0, -180, 0, 10.000000, ""); mE(b_25, 0.000000); UsedBlocks->Add(b_25);
	auto b_26 = make1(1, 24, -19, 8, 1, 1, 1, 0, -180, 0, 10.000000, ""); mE(b_26, 0.000000); UsedBlocks->Add(b_26);
	auto b_27 = make1(1, 24, -22, 9, 1, 1, 2, 0, 180, 90, 20.000000, ""); mE(b_27, 0.000000); UsedBlocks->Add(b_27);
	auto b_28 = make1(1, 24, -10, 9, 1, 1, 11, 0, -180, 0, 110.000000, ""); mE(b_28, 0.000000); UsedBlocks->Add(b_28);
	auto b_29 = make1(2, 24, -30, 9, 1, 2, 5, 0, 0, 0, 100.000000, ""); UsedBlocks->Add(b_29);
	auto b_30 = make1(2, 24, -12, 9, 1, 2, 5, 0, 0, 0, 100.000000, ""); UsedBlocks->Add(b_30);
	auto b_31 = make1(2, 24, -16, 9, 1, 1, 5, 0, -180, 0, 50.000000, ""); UsedBlocks->Add(b_31);
	auto b_32 = make1(2, 24, -20, 9, 1, 1, 5, 0, -180, 0, 50.000000, ""); UsedBlocks->Add(b_32);
	auto b_33 = make1(2, 24, -27, 9, 1, 1, 5, 0, -180, 0, 50.000000, ""); UsedBlocks->Add(b_33);
	auto b_34 = make1(2, 24, -24, 9, 1, 2, 5, 0, 180, 0, 100.000000, ""); UsedBlocks->Add(b_34);
	auto b_35 = make1(2, 24, -13, 8, 1, 1, 4, 0, -90, 0, 40.000000, ""); UsedBlocks->Add(b_35);
	auto b_36 = make1(2, 24, -15, 8, 1, 1, 4, 0, -90, 0, 40.000000, ""); UsedBlocks->Add(b_36);
	auto b_37 = make1(2, 24, -18, 9, 1, 1, 3, 0, 180, 0, 30.000000, ""); UsedBlocks->Add(b_37);
	auto b_38 = make1(2, 24, -23, 10, 1, 1, 2, 0, -180, -90, 20.000000, ""); UsedBlocks->Add(b_38);
	auto b_39 = make1(2, 24, -22, 7, 1, 1, 2, 0, -180, 0, 20.000000, ""); UsedBlocks->Add(b_39);
	auto b_40 = make1(2, 24, -23, 7, 1, 1, 2, 0, -180, 0, 20.000000, ""); UsedBlocks->Add(b_40);
	auto b_41 = make1(2, 24, -19, 9, 1, 1, 1, 0, -180, 0, 10.000000, ""); UsedBlocks->Add(b_41);
	auto b_42 = make1(1, -15, -39, 9, 1, 1, 11, 0, 180, 0, 110.000000, ""); mE(b_42, 0.000000); mEP(b_42, 1, 1, 1.000000); UsedBlocks->Add(b_42);
	auto b_43 = make1(1000, 23, -30, 4, 1, 1, 1, 0, 90, 0, 10.000000, ""); mE(b_43, 2000.000000); mEP(b_43, 1, 1, 1.000000);
	mr(b_43, "97CF1EDB4D942B960C31B5A6AF7B17E6"); UsedBlocks->Add(b_43);
	auto b_44 = make1(1000, 23, -11, 4, 1, 1, 1, 0, 90, 0, 10.000000, ""); mE(b_44, 2000.000000); mEP(b_44, 1, 1, 1.000000);
	mr(b_44, "24CDB92B4512372CBCCAA9842D3C73FD"); UsedBlocks->Add(b_44);
	auto b_45 = make1(1, 22, -20, 9, 1, 20, 11, 0, 180, 0, 2200.000000, ""); mE(b_45, 0.000000); mEP(b_45, 1, 1, 1.000000); UsedBlocks->Add(b_45);
	auto b_46 = make1(500, 21, -21, 11, 1, 8, 5, 0, 0, 0, 10.000000, ""); mE(b_46, 100000.000000); UsedBlocks->Add(b_46);
	auto b_47 = make1(101, 21, -20, 8, 8, 1, 1, 0, -90, 180, 26.666668, ""); mE(b_47, 0.000000); UsedBlocks->Add(b_47);
	auto b_48 = make1(1150, 14, -13, 4, 3, 3, 2, 0, -180, 0, 180.000000, ""); mE(b_48, 18000.000000); UsedBlocks->Add(b_48);
	auto b_49 = make1(1150, 11, -13, 4, 3, 3, 2, 0, -180, 0, 180.000000, ""); mE(b_49, 18000.000000); UsedBlocks->Add(b_49);
	auto b_50 = make1(1150, 14, -10, 4, 3, 3, 2, 0, -180, 0, 180.000000, ""); mE(b_50, 18000.000000); UsedBlocks->Add(b_50);
	auto b_51 = make1(1, 9, -12, 4, 6, 1, 1, 0, 90, 0, 60.000000, ""); mE(b_51, 0.000000); UsedBlocks->Add(b_51);
	auto b_52 = make1(1, 12, -15, 4, 6, 1, 1, 0, 0, 0, 60.000000, ""); mE(b_52, 0.000000); UsedBlocks->Add(b_52);
	auto b_53 = make1(1, 16, -11, 4, 6, 1, 1, 0, -90, 0, 60.000000, ""); mE(b_53, 0.000000); UsedBlocks->Add(b_53);
	auto b_54 = make1(1, 13, -8, 4, 6, 1, 1, 0, 180, 0, 60.000000, ""); mE(b_54, 0.000000); UsedBlocks->Add(b_54);
	auto b_55 = make1(101, 8, -12, 4, 8, 1, 1, 0, 90, 0, 26.666668, ""); mE(b_55, 0.000000); UsedBlocks->Add(b_55);
	auto b_56 = make1(101, 13, -16, 4, 8, 1, 1, 0, 180, 0, 26.666668, ""); mE(b_56, 0.000000); UsedBlocks->Add(b_56);
	auto b_57 = make1(101, 17, -11, 4, 8, 1, 1, 0, -90, 0, 26.666668, ""); mE(b_57, 0.000000); UsedBlocks->Add(b_57);
	auto b_58 = make1(101, 12, -7, 4, 8, 1, 1, 0, 0, 0, 26.666668, ""); mE(b_58, 0.000000); UsedBlocks->Add(b_58);
	auto b_59 = make1(201, 8, -7, 4, 1, 1, 1, 0, 90, 0, 5.000000, ""); mE(b_59, 0.000000); UsedBlocks->Add(b_59);
	auto b_60 = make1(201, 8, -16, 4, 1, 1, 1, 0, 180, 0, 5.000000, ""); mE(b_60, 0.000000); UsedBlocks->Add(b_60);
	auto b_61 = make1(201, 17, -16, 4, 1, 1, 1, 0, -90, 0, 5.000000, ""); mE(b_61, 0.000000); UsedBlocks->Add(b_61);
	auto b_62 = make1(201, 17, -7, 4, 1, 1, 1, 0, 0, 0, 5.000000, ""); mE(b_62, 0.000000); UsedBlocks->Add(b_62);
	auto b_63 = make1(1, 9, -8, 4, 1, 1, 1, 0, -90, 0, 10.000000, ""); mE(b_63, 0.000000); UsedBlocks->Add(b_63);
	auto b_64 = make1(1, 16, -8, 4, 1, 1, 1, 0, -90, 0, 10.000000, ""); mE(b_64, 0.000000); UsedBlocks->Add(b_64);
	auto b_65 = make1(1, 16, -15, 4, 1, 1, 1, 0, -90, 0, 10.000000, ""); mE(b_65, 0.000000); UsedBlocks->Add(b_65);
	auto b_66 = make1(1, 9, -15, 4, 1, 1, 1, 0, -90, 0, 10.000000, ""); mE(b_66, 0.000000); UsedBlocks->Add(b_66);
	auto b_67 = make1(101, 16, -15, 8, 7, 1, 1, 90, -90, 90, 23.333334, ""); mE(b_67, 0.000000); UsedBlocks->Add(b_67);
	auto b_68 = make1(101, 9, -15, 8, 7, 1, 1, 90, 0, -90, 23.333334, ""); mE(b_68, 0.000000); UsedBlocks->Add(b_68);
	auto b_69 = make1(101, 9, -8, 8, 7, 1, 1, 90, 0, 0, 23.333334, ""); mE(b_69, 0.000000); UsedBlocks->Add(b_69);
	auto b_70 = make1(101, 16, -8, 8, 7, 1, 1, 90, 0, 90, 23.333334, ""); mE(b_70, 0.000000); UsedBlocks->Add(b_70);
	auto b_71 = make1(201, 16, -8, 12, 1, 1, 1, 0, 0, 0, 5.000000, ""); mE(b_71, 0.000000); UsedBlocks->Add(b_71);
	auto b_72 = make1(201, 9, -8, 12, 1, 1, 1, 0, 90, 0, 5.000000, ""); mE(b_72, 0.000000); UsedBlocks->Add(b_72);
	auto b_73 = make1(201, 9, -15, 12, 1, 1, 1, 0, -180, 0, 5.000000, ""); mE(b_73, 0.000000); UsedBlocks->Add(b_73);
	auto b_74 = make1(201, 16, -15, 12, 1, 1, 1, 0, -90, 0, 5.000000, ""); mE(b_74, 0.000000); UsedBlocks->Add(b_74);
	auto b_75 = make1(101, 12, -15, 12, 6, 1, 1, 0, 0, -90, 20.000000, ""); mE(b_75, 0.000000); UsedBlocks->Add(b_75);
	auto b_76 = make1(101, 16, -11, 12, 6, 1, 1, 0, -90, 0, 20.000000, ""); mE(b_76, 0.000000); UsedBlocks->Add(b_76);
	auto b_77 = make1(101, 12, -8, 12, 6, 1, 1, 0, 0, 0, 20.000000, ""); mE(b_77, 0.000000); UsedBlocks->Add(b_77);
	auto b_78 = make1(101, 9, -12, 12, 6, 1, 1, 0, 90, 0, 20.000000, ""); mE(b_78, 0.000000); UsedBlocks->Add(b_78);
	auto b_79 = make1(2, 13, -12, 12, 6, 6, 1, 0, 90, 0, 360.000000, ""); UsedBlocks->Add(b_79);
	auto b_80 = make1(2, 12, -8, 8, 6, 1, 7, 0, 0, 0, 420.000000, ""); UsedBlocks->Add(b_80);
	auto b_81 = make1(1200, 11, -10, 5, 3, 3, 3, 0, 0, 0, 10.000000, ""); mE(b_81, 100000.000000); UsedBlocks->Add(b_81);
	auto b_82 = make1(1, 3, -21, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_82, 0.000000); UsedBlocks->Add(b_82);
	auto b_83 = make1(1, -15, -21, 9, 1, 1, 11, 0, 90, 0, 110.000000, ""); mE(b_83, 0.000000); UsedBlocks->Add(b_83);
	auto b_84 = make1(600, -15, -30, 9, 17, 1, 11, 0, -90, 0, 1870.000000, ""); mE(b_84, 74800.000000); UsedBlocks->Add(b_84);
	auto b_85 = make1(600, -6, -21, 9, 17, 1, 11, 0, 0, 0, 1870.000000, ""); mE(b_85, 74800.000000); UsedBlocks->Add(b_85);
	auto b_86 = make1(2, 16, -12, 8, 6, 1, 7, 0, 90, 0, 420.000000, ""); UsedBlocks->Add(b_86);
	auto b_87 = make1(2, 14, -15, 8, 3, 1, 7, 0, 0, 0, 210.000000, ""); UsedBlocks->Add(b_87);
	auto b_88 = make1(2, 11, -15, 6, 3, 1, 4, 0, 0, 0, 120.000000, ""); UsedBlocks->Add(b_88);
	auto b_89 = make1(0, -26, -12, 1, 20, 20, 4, 0, 0, 0, 16000.000000, ""); mE(b_89, 0.000000); UsedBlocks->Add(b_89);
	auto b_90 = make1(0, -26, 8, 1, 20, 20, 4, 0, 0, 0, 16000.000000, ""); mE(b_90, 0.000000); UsedBlocks->Add(b_90);
	auto b_91 = make1(0, -5, 14, 1, 20, 10, 4, 0, -180, 0, 8000.000000, ""); mE(b_91, 0.000000); UsedBlocks->Add(b_91);
	auto b_92 = make1(0, 15, 14, 1, 20, 10, 4, 0, -180, 0, 8000.000000, ""); mE(b_92, 0.000000); UsedBlocks->Add(b_92);
	auto b_93 = make1(1150, 12, 6, 4, 9, 9, 2, 0, 0, 0, 1620.000000, ""); mE(b_93, 162000.000000); UsedBlocks->Add(b_93);
	auto b_94 = make1(2, 7, 6, 9, 9, 1, 10, 0, 90, 0, 900.000000, ""); UsedBlocks->Add(b_94);
	auto b_95 = make1(2, 12, 11, 9, 9, 1, 10, 0, 180, 0, 900.000000, ""); UsedBlocks->Add(b_95);
	auto b_96 = make1(2, 17, 6, 9, 9, 1, 10, 0, 90, 0, 900.000000, ""); UsedBlocks->Add(b_96);
	auto b_97 = make1(2, 12, 1, 9, 9, 1, 10, 0, -180, 0, 900.000000, ""); UsedBlocks->Add(b_97);
	auto b_98 = make1(2, 12, 6, 15, 9, 9, 1, 0, -90, 0, 810.000000, ""); UsedBlocks->Add(b_98);
