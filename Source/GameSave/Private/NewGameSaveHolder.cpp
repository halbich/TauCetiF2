...
USaveGameCarrier* UNewGameSaveHolder::getDefaultGameSave(bool full)
{
	...
	FRelationshipInfo b_12_rel0; FGuid b_12_rel0_id; FGuid::Parse("797CEC8E499C456A5E1C46B8312736AB", b_12_rel0_id); b_12_rel0.TargetID = b_12_rel0_id; b_12_rel0.RelationshipType = 0;
	...
	auto b_45 = make(1100, FVector(11, 38, 0), FVector(20, 20, 2), FRotator(0, 0, 0), 1100, ""); b_45.HasElectricityData = true; b_45.ElectricityInfo.CurrentObjectEnergy = 159672.000000;  UsedBlocks->Add(b_45);
	...
	auto b_47 = make(1100, FVector(31, 38, 0), FVector(20, 20, 2), FRotator(0, 0, 0), 1100, ""); b_47.HasElectricityData = true; b_47.ElectricityInfo.CurrentObjectEnergy = 159708.000000;  UsedBlocks->Add(b_47);
	auto b_48 = make(1100, FVector(31, 58, 0), FVector(20, 20, 2), FRotator(0, 0, 0), 1100, ""); b_48.HasElectricityData = true; b_48.ElectricityInfo.CurrentObjectEnergy = 159373.000000;  UsedBlocks->Add(b_48);
	...
	b_51.HasRelationshipData = true; FGuid b_51_rel_id; FGuid::Parse("797CEC8E499C456A5E1C46B8312736AB", b_51_rel_id); b_51.RelationshipInfo.ID = b_51_rel_id;
	FRelationshipInfo b_51_rel0; FGuid b_51_rel0_id; FGuid::Parse("703EFD1844A5E576A5932288A38E20B9", b_51_rel0_id); b_51_rel0.TargetID = b_51_rel0_id; b_51_rel0.RelationshipType = 1;
	...
	auto b_58 = make(1000, FVector(23, -20, 12), FVector(1, 1, 1), FRotator(0, 90, 90), 1000, "stena"); b_58.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0")); b_58.BlockSpecificData.Add(TEXT("IsOn"), TEXT("0"));
	...
	FRelationshipInfo b_58_rel0; FGuid b_58_rel0_id; FGuid::Parse("6EEA645949C55B8F90F421AB704204C1", b_58_rel0_id); b_58_rel0.TargetID = b_58_rel0_id; b_58_rel0.RelationshipType = 0;
	...
	auto b_77 = make(1400, FVector(22, -10, 5), FVector(4, 3, 4), FRotator(0, 90, 0), 1400, "Plnicka"); b_77.HasElectricityData = true; b_77.ElectricityInfo.CurrentObjectEnergy = 150.000000; b_77.HasOxygenData = true; b_77.OxygenInfo.CurrentObjectOxygen = 150.000000;
	b_77.HasRelationshipData = true; FGuid b_77_rel_id; FGuid::Parse("A9F299C54AB0F2B6ABEBC280C23BF218", b_77_rel_id); b_77.RelationshipInfo.ID = b_77_rel_id;
	FRelationshipInfo b_77_rel0; FGuid b_77_rel0_id; FGuid::Parse("6EEA645949C55B8F90F421AB704204C1", b_77_rel0_id); b_77_rel0.TargetID = b_77_rel0_id; b_77_rel0.RelationshipType = 0;
	b_77.RelationshipInfo.Relationships.Add(b_77_rel0); UsedBlocks->Add(b_77);
	...
	b_78.HasRelationshipData = true; FGuid b_78_rel_id; FGuid::Parse("6EEA645949C55B8F90F421AB704204C1", b_78_rel_id); b_78.RelationshipInfo.ID = b_78_rel_id;
	FRelationshipInfo b_78_rel0; FGuid b_78_rel0_id; FGuid::Parse("A9F299C54AB0F2B6ABEBC280C23BF218", b_78_rel0_id); b_78_rel0.TargetID = b_78_rel0_id; b_78_rel0.RelationshipType = 1;
	b_78.RelationshipInfo.Relationships.Add(b_78_rel0);
	FRelationshipInfo b_78_rel1; FGuid b_78_rel1_id; FGuid::Parse("053D69F542E0BAEAD45D9D9ED75F3844", b_78_rel1_id); b_78_rel1.TargetID = b_78_rel1_id; b_78_rel1.RelationshipType = 1;
	b_78.RelationshipInfo.Relationships.Add(b_78_rel1); UsedBlocks->Add(b_78);
	...
	b_96.HasElectricityData = true; b_96.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	...
	FRelationshipInfo b_96_rel0; FGuid b_96_rel0_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_96_rel0_id); b_96_rel0.TargetID = b_96_rel0_id; b_96_rel0.RelationshipType = 0;
	b_96.RelationshipInfo.Relationships.Add(b_96_rel0);
	FRelationshipInfo b_96_rel1; FGuid b_96_rel1_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_96_rel1_id); b_96_rel1.TargetID = b_96_rel1_id; b_96_rel1.RelationshipType = 1;
	b_96.RelationshipInfo.Relationships.Add(b_96_rel1); UsedBlocks->Add(b_96);
	auto b_97 = make(1000, FVector(8, -35, 17), FVector(1, 1, 1), FRotator(0, 90, -180), 1000, "venku"); b_97.BlockSpecificData.Add(TEXT("IsON"), TEXT("0")); b_97.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0"));
	b_97.HasElectricityData = true; b_97.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	b_97.HasRelationshipData = true; FGuid b_97_rel_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_97_rel_id); b_97.RelationshipInfo.ID = b_97_rel_id;
	FRelationshipInfo b_97_rel0; FGuid b_97_rel0_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_97_rel0_id); b_97_rel0.TargetID = b_97_rel0_id; b_97_rel0.RelationshipType = 0;
	b_97.RelationshipInfo.Relationships.Add(b_97_rel0);
	FRelationshipInfo b_97_rel1; FGuid b_97_rel1_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_97_rel1_id); b_97_rel1.TargetID = b_97_rel1_id; b_97_rel1.RelationshipType = 1;
	b_97.RelationshipInfo.Relationships.Add(b_97_rel1); UsedBlocks->Add(b_97);
	auto b_98 = make(1000, FVector(15, -35, 17), FVector(1, 1, 1), FRotator(0, 90, -180), 1000, "venku"); b_98.BlockSpecificData.Add(TEXT("IsON"), TEXT("0")); b_98.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0"));
	b_98.HasElectricityData = true; b_98.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	b_98.HasRelationshipData = true; FGuid b_98_rel_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_98_rel_id); b_98.RelationshipInfo.ID = b_98_rel_id;
	FRelationshipInfo b_98_rel0; FGuid b_98_rel0_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_98_rel0_id); b_98_rel0.TargetID = b_98_rel0_id; b_98_rel0.RelationshipType = 0;
	b_98.RelationshipInfo.Relationships.Add(b_98_rel0);
	FRelationshipInfo b_98_rel1; FGuid b_98_rel1_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_98_rel1_id); b_98_rel1.TargetID = b_98_rel1_id; b_98_rel1.RelationshipType = 1;
	b_98.RelationshipInfo.Relationships.Add(b_98_rel1); UsedBlocks->Add(b_98);
	auto b_99 = make(1000, FVector(23, -35, 17), FVector(1, 1, 1), FRotator(0, 90, -180), 1000, "venku"); b_99.BlockSpecificData.Add(TEXT("IsON"), TEXT("0")); b_99.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0"));
	b_99.HasElectricityData = true; b_99.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	b_99.HasRelationshipData = true; FGuid b_99_rel_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_99_rel_id); b_99.RelationshipInfo.ID = b_99_rel_id;
	FRelationshipInfo b_99_rel0; FGuid b_99_rel0_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_99_rel0_id); b_99_rel0.TargetID = b_99_rel0_id; b_99_rel0.RelationshipType = 0;
	b_99.RelationshipInfo.Relationships.Add(b_99_rel0);
	FRelationshipInfo b_99_rel1; FGuid b_99_rel1_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_99_rel1_id); b_99_rel1.TargetID = b_99_rel1_id; b_99_rel1.RelationshipType = 1;
	b_99.RelationshipInfo.Relationships.Add(b_99_rel1); UsedBlocks->Add(b_99);
	auto b_100 = make(1000, FVector(26, -41, 14), FVector(1, 1, 1), FRotator(0, 90, -180), 1000, "venku"); b_100.BlockSpecificData.Add(TEXT("IsON"), TEXT("0")); b_100.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0"));
	b_100.HasElectricityData = true; b_100.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	b_100.HasRelationshipData = true; FGuid b_100_rel_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_100_rel_id); b_100.RelationshipInfo.ID = b_100_rel_id;
	FRelationshipInfo b_100_rel0; FGuid b_100_rel0_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_100_rel0_id); b_100_rel0.TargetID = b_100_rel0_id; b_100_rel0.RelationshipType = 0;
	b_100.RelationshipInfo.Relationships.Add(b_100_rel0);
	FRelationshipInfo b_100_rel1; FGuid b_100_rel1_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_100_rel1_id); b_100_rel1.TargetID = b_100_rel1_id; b_100_rel1.RelationshipType = 1;
	b_100.RelationshipInfo.Relationships.Add(b_100_rel1); UsedBlocks->Add(b_100);
	auto b_101 = make(1000, FVector(5, -42, 14), FVector(1, 1, 1), FRotator(0, 90, -180), 1000, "venku"); b_101.BlockSpecificData.Add(TEXT("IsON"), TEXT("0")); b_101.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0"));
	b_101.HasElectricityData = true; b_101.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	b_101.HasRelationshipData = true; FGuid b_101_rel_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_101_rel_id); b_101.RelationshipInfo.ID = b_101_rel_id;
	FRelationshipInfo b_101_rel0; FGuid b_101_rel0_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_101_rel0_id); b_101_rel0.TargetID = b_101_rel0_id; b_101_rel0.RelationshipType = 0;
	b_101.RelationshipInfo.Relationships.Add(b_101_rel0);
	FRelationshipInfo b_101_rel1; FGuid b_101_rel1_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_101_rel1_id); b_101_rel1.TargetID = b_101_rel1_id; b_101_rel1.RelationshipType = 1;
	b_101.RelationshipInfo.Relationships.Add(b_101_rel1); UsedBlocks->Add(b_101);
	auto b_102 = make(1000, FVector(-17, -41, 14), FVector(1, 1, 1), FRotator(0, 90, -180), 1000, "venku"); b_102.BlockSpecificData.Add(TEXT("IsON"), TEXT("0")); b_102.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0"));
	b_102.HasElectricityData = true; b_102.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	b_102.HasRelationshipData = true; FGuid b_102_rel_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_102_rel_id); b_102.RelationshipInfo.ID = b_102_rel_id;
	FRelationshipInfo b_102_rel0; FGuid b_102_rel0_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_102_rel0_id); b_102_rel0.TargetID = b_102_rel0_id; b_102_rel0.RelationshipType = 0;
	b_102.RelationshipInfo.Relationships.Add(b_102_rel0);
	FRelationshipInfo b_102_rel1; FGuid b_102_rel1_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_102_rel1_id); b_102_rel1.TargetID = b_102_rel1_id; b_102_rel1.RelationshipType = 1;
	b_102.RelationshipInfo.Relationships.Add(b_102_rel1); UsedBlocks->Add(b_102);
	auto b_103 = make(1000, FVector(-18, -19, 14), FVector(1, 1, 1), FRotator(0, 90, -180), 1000, "venku"); b_103.BlockSpecificData.Add(TEXT("IsON"), TEXT("0")); b_103.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0"));
	b_103.HasElectricityData = true; b_103.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	b_103.HasRelationshipData = true; FGuid b_103_rel_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_103_rel_id); b_103.RelationshipInfo.ID = b_103_rel_id;
	FRelationshipInfo b_103_rel0; FGuid b_103_rel0_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_103_rel0_id); b_103_rel0.TargetID = b_103_rel0_id; b_103_rel0.RelationshipType = 0;
	b_103.RelationshipInfo.Relationships.Add(b_103_rel0);
	FRelationshipInfo b_103_rel1; FGuid b_103_rel1_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_103_rel1_id); b_103_rel1.TargetID = b_103_rel1_id; b_103_rel1.RelationshipType = 1;
	b_103.RelationshipInfo.Relationships.Add(b_103_rel1); UsedBlocks->Add(b_103);
	auto b_104 = make(1000, FVector(-18, 1, 14), FVector(1, 1, 1), FRotator(0, 90, -180), 1000, "venku"); b_104.BlockSpecificData.Add(TEXT("IsON"), TEXT("0")); b_104.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0"));
	b_104.HasElectricityData = true; b_104.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	b_104.HasRelationshipData = true; FGuid b_104_rel_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_104_rel_id); b_104.RelationshipInfo.ID = b_104_rel_id;
	FRelationshipInfo b_104_rel0; FGuid b_104_rel0_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_104_rel0_id); b_104_rel0.TargetID = b_104_rel0_id; b_104_rel0.RelationshipType = 0;
	b_104.RelationshipInfo.Relationships.Add(b_104_rel0);
	FRelationshipInfo b_104_rel1; FGuid b_104_rel1_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_104_rel1_id); b_104_rel1.TargetID = b_104_rel1_id; b_104_rel1.RelationshipType = 1;
	b_104.RelationshipInfo.Relationships.Add(b_104_rel1); UsedBlocks->Add(b_104);
	auto b_105 = make(1000, FVector(-17, 22, 14), FVector(1, 1, 1), FRotator(0, 90, -180), 1000, "venku"); b_105.BlockSpecificData.Add(TEXT("IsON"), TEXT("0")); b_105.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0"));
	b_105.HasElectricityData = true; b_105.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	b_105.HasRelationshipData = true; FGuid b_105_rel_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_105_rel_id); b_105.RelationshipInfo.ID = b_105_rel_id;
	FRelationshipInfo b_105_rel0; FGuid b_105_rel0_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_105_rel0_id); b_105_rel0.TargetID = b_105_rel0_id; b_105_rel0.RelationshipType = 0;
	b_105.RelationshipInfo.Relationships.Add(b_105_rel0);
	FRelationshipInfo b_105_rel1; FGuid b_105_rel1_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_105_rel1_id); b_105_rel1.TargetID = b_105_rel1_id; b_105_rel1.RelationshipType = 1;
	b_105.RelationshipInfo.Relationships.Add(b_105_rel1); UsedBlocks->Add(b_105);
	auto b_106 = make(1000, FVector(5, 23, 14), FVector(1, 1, 1), FRotator(0, 90, -180), 1000, "venku"); b_106.BlockSpecificData.Add(TEXT("IsON"), TEXT("0")); b_106.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0"));
	b_106.HasElectricityData = true; b_106.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	b_106.HasRelationshipData = true; FGuid b_106_rel_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_106_rel_id); b_106.RelationshipInfo.ID = b_106_rel_id;
	FRelationshipInfo b_106_rel0; FGuid b_106_rel0_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_106_rel0_id); b_106_rel0.TargetID = b_106_rel0_id; b_106_rel0.RelationshipType = 0;
	b_106.RelationshipInfo.Relationships.Add(b_106_rel0);
	FRelationshipInfo b_106_rel1; FGuid b_106_rel1_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_106_rel1_id); b_106_rel1.TargetID = b_106_rel1_id; b_106_rel1.RelationshipType = 1;
	b_106.RelationshipInfo.Relationships.Add(b_106_rel1); UsedBlocks->Add(b_106);
	auto b_107 = make(1000, FVector(26, 22, 14), FVector(1, 1, 1), FRotator(0, 90, -180), 1000, "venku"); b_107.BlockSpecificData.Add(TEXT("IsON"), TEXT("0")); b_107.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0"));
	b_107.HasElectricityData = true; b_107.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	b_107.HasRelationshipData = true; FGuid b_107_rel_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_107_rel_id); b_107.RelationshipInfo.ID = b_107_rel_id;
	FRelationshipInfo b_107_rel0; FGuid b_107_rel0_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_107_rel0_id); b_107_rel0.TargetID = b_107_rel0_id; b_107_rel0.RelationshipType = 0;
	b_107.RelationshipInfo.Relationships.Add(b_107_rel0);
	FRelationshipInfo b_107_rel1; FGuid b_107_rel1_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_107_rel1_id); b_107_rel1.TargetID = b_107_rel1_id; b_107_rel1.RelationshipType = 1;
	b_107.RelationshipInfo.Relationships.Add(b_107_rel1); UsedBlocks->Add(b_107);
	auto b_108 = make(1000, FVector(26, -18, 14), FVector(1, 1, 1), FRotator(0, -90, -180), 1000, "venku"); b_108.BlockSpecificData.Add(TEXT("IsON"), TEXT("0")); b_108.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0"));
	b_108.HasElectricityData = true; b_108.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	b_108.HasRelationshipData = true; FGuid b_108_rel_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_108_rel_id); b_108.RelationshipInfo.ID = b_108_rel_id;
	FRelationshipInfo b_108_rel0; FGuid b_108_rel0_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_108_rel0_id); b_108_rel0.TargetID = b_108_rel0_id; b_108_rel0.RelationshipType = 0;
	b_108.RelationshipInfo.Relationships.Add(b_108_rel0);
	FRelationshipInfo b_108_rel1; FGuid b_108_rel1_id; FGuid::Parse("5CCE09794A8BA7EDD12133AFE8BA3E40", b_108_rel1_id); b_108_rel1.TargetID = b_108_rel1_id; b_108_rel1.RelationshipType = 1;
	b_108.RelationshipInfo.Relationships.Add(b_108_rel1); UsedBlocks->Add(b_108);
	c->PlayerPosition = FVector(1033, -813, 82);
