...
USaveGameCarrier* UNewGameSaveHolder::getTutorialGameSave(bool full)
{
	...
	auto b_136 = make1(1150, 11, -10, 4, 3, 3, 2, 0, 90, 0, 180.000000, ""); mE(b_136, 18000.000000); UsedBlocks->Add(b_136);
	auto b_137 = make1(2, 9, -12, 8, 6, 7, 1, 0, 90, -90, 420.000000, ""); UsedBlocks->Add(b_137);
	auto b_138 = make1(2, 11, -15, 10, 3, 1, 3, 0, 0, 0, 90.000000, ""); UsedBlocks->Add(b_138);
	auto b_139 = make1(1200, -18, 16, 5, 3, 3, 3, 0, 90, 0, 10.000000, ""); mE(b_139, 150.000000); mEP(b_139, 1, 1, 1.000000); UsedBlocks->Add(b_139);
	auto b_140 = make1(1200, -18, 16, 8, 3, 3, 3, 0, 90, 0, 10.000000, ""); mE(b_140, 150.000000); mEP(b_140, 1, 1, 1.000000); UsedBlocks->Add(b_140);
	auto b_141 = make1(1200, -18, 16, 11, 3, 3, 3, 0, 90, 0, 10.000000, ""); mE(b_141, 150.000000); mEP(b_141, 1, 1, 1.000000); UsedBlocks->Add(b_141);
	auto b_142 = make1(1200, -18, 13, 5, 3, 3, 3, 0, 90, 0, 10.000000, ""); mE(b_142, 150.000000); mEP(b_142, 1, 1, 1.000000); UsedBlocks->Add(b_142);
	auto b_143 = make1(1200, -18, 13, 8, 3, 3, 3, 0, 90, 0, 10.000000, ""); mE(b_143, 150.000000); mEP(b_143, 1, 1, 1.000000); UsedBlocks->Add(b_143);
	auto b_144 = make1(1200, -18, 13, 11, 3, 3, 3, 0, 90, 0, 10.000000, ""); mE(b_144, 150.000000); mEP(b_144, 1, 1, 1.000000); UsedBlocks->Add(b_144);
	auto b_145 = make1(1200, -18, 10, 5, 3, 3, 3, 0, 90, 0, 10.000000, ""); mE(b_145, 150.000000); mEP(b_145, 1, 1, 1.000000); UsedBlocks->Add(b_145);
	auto b_146 = make1(1200, -18, 10, 8, 3, 3, 3, 0, 90, 0, 10.000000, ""); mE(b_146, 150.000000); mEP(b_146, 1, 1, 1.000000); UsedBlocks->Add(b_146);
	auto b_147 = make1(1200, -18, 10, 11, 3, 3, 3, 0, 90, 0, 10.000000, ""); mE(b_147, 150.000000); mEP(b_147, 1, 1, 1.000000); UsedBlocks->Add(b_147);
	auto b_148 = make1(1200, -18, 10, 14, 3, 3, 3, 0, 90, 0, 10.000000, ""); mE(b_148, 150.000000); mEP(b_148, 1, 1, 1.000000); UsedBlocks->Add(b_148);
	auto b_149 = make1(1200, -18, 13, 14, 3, 3, 3, 0, 90, 0, 10.000000, ""); mE(b_149, 150.000000); mEP(b_149, 1, 1, 1.000000); UsedBlocks->Add(b_149);
	auto b_150 = make1(1200, -18, 16, 14, 3, 3, 3, 0, 90, 0, 10.000000, ""); mE(b_150, 150.000000); mEP(b_150, 1, 1, 1.000000); UsedBlocks->Add(b_150);
	auto b_151 = make1(1400, -13, -18, 5, 4, 3, 4, 0, 0, 0, 10.000000, "P1"); bd(b_151, TEXT("ItemTags"), TEXT("")); bd(b_151, TEXT("HasItem"), TEXT("0")); bd(b_151, TEXT("CurrentFilling"), TEXT("0.0")); mE(b_151, 150.000000); mEP(b_151, 1, 1, 1.000000); mO(b_151, 1000.000000);
	mr(b_151, "469CB5F14D6D183C7F32AFACAC1B157D"); mrc(b_151, "6EF43F13408CD16117341C9C24CF0B84", 0); UsedBlocks->Add(b_151);
	auto b_152 = make1(1500, -8, -18, 4, 2, 2, 2, 0, -90, 0, 10.000000, ""); bd(b_152, TEXT("ItemTags"), TEXT("")); mO(b_152, 1000.000000); UsedBlocks->Add(b_152);
	auto b_153 = make1(1050, -15, -20, 11, 1, 1, 1, 0, 0, 90, 10.000000, "V1"); bd(b_153, TEXT("ReactsToDayCycle"), TEXT("0")); bd(b_153, TEXT("StateAtDay"), TEXT("0")); bd(b_153, TEXT("StateAtNight"), TEXT("0")); mE(b_153, 0.000000); mEP(b_153, 1, 1, 1.000000);
	mr(b_153, "6EF43F13408CD16117341C9C24CF0B84"); mrc(b_153, "469CB5F14D6D183C7F32AFACAC1B157D", 1); UsedBlocks->Add(b_153);
	auto b_154 = make1(1050, -5, 6, 11, 1, 1, 1, 90, 0, 0, 10.000000, "V2"); bd(b_154, TEXT("ReactsToDayCycle"), TEXT("0")); bd(b_154, TEXT("StateAtDay"), TEXT("0")); bd(b_154, TEXT("StateAtNight"), TEXT("0")); mE(b_154, 0.000000); mEP(b_154, 0, 1, 1.000000);
	mr(b_154, "F0004A164B28EB3091C545ABA3C0C027"); mrc(b_154, "32551A924362FD87E92200913083304E", 1); UsedBlocks->Add(b_154);
	auto b_155 = make1(1000, -14, 16, 13, 1, 1, 1, 90, 0, -90, 10.000000, "S2"); mE(b_155, 2000.000000); mEP(b_155, 0, 1, 1.000000);
	mr(b_155, "32551A924362FD87E92200913083304E"); mrc(b_155, "F0004A164B28EB3091C545ABA3C0C027", 0); UsedBlocks->Add(b_155);
	auto b_156 = make1(1000, -34, -1, 14, 1, 1, 1, 0, -90, 90, 10.000000, ""); mE(b_156, 2000.000000); mEP(b_156, 1, 1, 1.000000);
	mr(b_156, "B74525F14F212109F925BD9CBA1606B7"); UsedBlocks->Add(b_156);
	auto b_157 = make1(1000, -34, -2, 14, 1, 1, 1, 0, -90, 90, 10.000000, ""); mE(b_157, 2000.000000); mEP(b_157, 1, 1, 1.000000);
	mr(b_157, "D34070B848F2B41D21BCF5A89B43F508"); UsedBlocks->Add(b_157);
