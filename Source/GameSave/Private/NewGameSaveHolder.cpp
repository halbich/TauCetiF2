...
USaveGameCarrier* UNewGameSaveHolder::getDefaultGameSave(bool full)
{
	...
	auto b_0 = make(0, FVector(-6, -2, 1), FVector(20, 20, 4), FRotator(0, 0, 0), -1, ""); b_0.HasElectricityData = true; b_0.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_0);
	auto b_1 = make(0, FVector(14, -2, 1), FVector(20, 20, 4), FRotator(0, 0, 0), -1, ""); b_1.HasElectricityData = true; b_1.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_1);
	auto b_2 = make(0, FVector(14, -22, 1), FVector(20, 20, 4), FRotator(0, 0, 0), -1, ""); b_2.HasElectricityData = true; b_2.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_2);
	auto b_3 = make(0, FVector(-6, -22, 1), FVector(20, 20, 4), FRotator(0, 0, 0), -1, ""); b_3.HasElectricityData = true; b_3.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_3);
	auto b_4 = make(500, FVector(0, -17, 6), FVector(1, 1, 1), FRotator(0, 0, 0), -1, ""); b_4.HasElectricityData = true; b_4.ElectricityInfo.CurrentObjectEnergy = 100000.000000;  UsedBlocks->Add(b_4);
	...
	auto b_10 = make(600, FVector(-12, -39, 9), FVector(6, 1, 11), FRotator(0, 0, 0), -1, ""); b_10.HasElectricityData = true; b_10.ElectricityInfo.CurrentObjectEnergy = 26400.000000;  UsedBlocks->Add(b_10);
	auto b_11 = make(100, FVector(10, -35, 1), FVector(8, 14, 4), FRotator(0, -90, 0), -1, ""); b_11.HasElectricityData = true; b_11.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_11);
	auto b_12 = make(1000, FVector(25, -13, 8), FVector(1, 1, 1), FRotator(0, 90, -90), -1, ""); b_12.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1")); b_12.BlockSpecificData.Add(TEXT("IsOn"), TEXT("1"));
	...
	auto b_13 = make(1000, FVector(13, 9, 3), FVector(1, 1, 1), FRotator(0, -180, -90), -1, ""); b_13.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1")); b_13.BlockSpecificData.Add(TEXT("IsOn"), TEXT("1"));
	...
	auto b_14 = make(1000, FVector(-16, -10, 2), FVector(1, 1, 1), FRotator(0, -90, -90), -1, ""); b_14.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1")); b_14.BlockSpecificData.Add(TEXT("IsOn"), TEXT("1"));
	...
	auto b_15 = make(0, FVector(-6, -35, 1), FVector(19, 8, 4), FRotator(0, 180, 0), -1, ""); b_15.HasElectricityData = true; b_15.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_15);
	auto b_16 = make(700, FVector(0, -35, 9), FVector(7, 7, 11), FRotator(0, 90, 0), -1, ""); b_16.AdditionalFlags.Add(TEXT("DoorOpening"), 0);
	...
	auto b_18 = make(600, FVector(0, -39, 9), FVector(6, 1, 11), FRotator(0, -180, 0), -1, ""); b_18.HasElectricityData = true; b_18.ElectricityInfo.CurrentObjectEnergy = 26400.000000;  UsedBlocks->Add(b_18);
	auto b_19 = make(600, FVector(-6, -39, 9), FVector(5, 1, 11), FRotator(0, 0, 0), -1, ""); b_19.HasElectricityData = true; b_19.ElectricityInfo.CurrentObjectEnergy = 22000.000000;  UsedBlocks->Add(b_19);
	auto b_20 = make(2, FVector(4, -27, 4), FVector(2, 7, 1), FRotator(0, 0, 0), -1, "");  UsedBlocks->Add(b_20);
	auto b_21 = make(2, FVector(6, -27, 5), FVector(2, 7, 1), FRotator(0, 0, 0), -1, "");  UsedBlocks->Add(b_21);
	auto b_22 = make(2, FVector(8, -27, 6), FVector(2, 7, 1), FRotator(0, 0, 0), -1, "");  UsedBlocks->Add(b_22);
	auto b_23 = make(2, FVector(10, -27, 7), FVector(2, 7, 1), FRotator(0, 0, 0), -1, "");  UsedBlocks->Add(b_23);
	auto b_24 = make(2, FVector(12, -27, 8), FVector(2, 7, 1), FRotator(0, 0, 0), -1, "");  UsedBlocks->Add(b_24);
	auto b_25 = make(2, FVector(14, -27, 9), FVector(2, 7, 1), FRotator(0, 0, 0), -1, "");  UsedBlocks->Add(b_25);
	...
	auto b_30 = make(2, FVector(16, -27, 10), FVector(2, 7, 1), FRotator(0, 0, 0), -1, "");  UsedBlocks->Add(b_30);
	...
	auto b_32 = make(2, FVector(20, -23, 11), FVector(2, 7, 1), FRotator(0, -90, 0), -1, "");  UsedBlocks->Add(b_32);
	auto b_33 = make(2, FVector(20, -21, 12), FVector(2, 7, 1), FRotator(0, -90, 0), -1, "");  UsedBlocks->Add(b_33);
	auto b_34 = make(2, FVector(20, -19, 13), FVector(2, 7, 1), FRotator(0, -90, 0), -1, "");  UsedBlocks->Add(b_34);
	auto b_35 = make(2, FVector(20, -17, 14), FVector(2, 7, 1), FRotator(0, -90, 0), -1, "");  UsedBlocks->Add(b_35);
	...
	auto b_37 = make(2, FVector(20, -15, 15), FVector(2, 7, 1), FRotator(0, -90, 0), -1, "");  UsedBlocks->Add(b_37);
	auto b_38 = make(2, FVector(20, -13, 16), FVector(2, 7, 1), FRotator(0, -90, 0), -1, "");  UsedBlocks->Add(b_38);
	auto b_39 = make(2, FVector(20, -11, 17), FVector(2, 7, 1), FRotator(0, -90, 0), -1, "");  UsedBlocks->Add(b_39);
	...
	auto b_42 = make(1100, FVector(11, 18, 0), FVector(20, 20, 2), FRotator(0, 0, 0), -1, ""); b_42.HasElectricityData = true; b_42.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_42);
	auto b_43 = make(1100, FVector(-9, 18, 0), FVector(20, 20, 2), FRotator(0, 0, 0), -1, ""); b_43.HasElectricityData = true; b_43.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_43);
	auto b_44 = make(1100, FVector(-9, 38, 0), FVector(20, 20, 2), FRotator(0, 0, 0), -1, ""); b_44.HasElectricityData = true; b_44.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_44);
	auto b_45 = make(1100, FVector(11, 38, 0), FVector(20, 20, 2), FRotator(0, 0, 0), -1, ""); b_45.HasElectricityData = true; b_45.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_45);
	auto b_46 = make(1100, FVector(31, 18, 0), FVector(20, 20, 2), FRotator(0, 0, 0), -1, ""); b_46.HasElectricityData = true; b_46.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_46);
	auto b_47 = make(1100, FVector(31, 38, 0), FVector(20, 20, 2), FRotator(0, 0, 0), -1, ""); b_47.HasElectricityData = true; b_47.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_47);
	auto b_48 = make(1100, FVector(31, 58, 0), FVector(20, 20, 2), FRotator(0, 0, 0), -1, ""); b_48.HasElectricityData = true; b_48.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_48);
	auto b_49 = make(1100, FVector(11, 59, 0), FVector(20, 20, 2), FRotator(0, -90, 0), -1, ""); b_49.HasElectricityData = true; b_49.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_49);
	auto b_50 = make(1100, FVector(-9, 59, 0), FVector(20, 20, 2), FRotator(0, -90, 0), -1, ""); b_50.HasElectricityData = true; b_50.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_50);
	auto b_51 = make(1050, FVector(-3, -9, 4), FVector(1, 1, 1), FRotator(0, 90, 0), -1, "Tlacitko na zemi"); b_51.BlockSpecificData.Add(TEXT("IsON"), TEXT("0"));
	...
	auto b_52 = make(600, FVector(24, -7, 11), FVector(5, 1, 4), FRotator(0, 90, 0), -1, ""); b_52.HasElectricityData = true; b_52.ElectricityInfo.CurrentObjectEnergy = 8000.000000;  UsedBlocks->Add(b_52);
	auto b_53 = make(600, FVector(24, -7, 15), FVector(5, 1, 4), FRotator(0, 90, 0), -1, ""); b_53.HasElectricityData = true; b_53.ElectricityInfo.CurrentObjectEnergy = 8000.000000;  UsedBlocks->Add(b_53);
	auto b_54 = make(600, FVector(24, -2, 11), FVector(5, 1, 4), FRotator(0, 90, 0), -1, ""); b_54.HasElectricityData = true; b_54.ElectricityInfo.CurrentObjectEnergy = 8000.000000;  UsedBlocks->Add(b_54);
	auto b_55 = make(600, FVector(24, -2, 15), FVector(5, 1, 4), FRotator(0, 90, 0), -1, ""); b_55.HasElectricityData = true; b_55.ElectricityInfo.CurrentObjectEnergy = 8000.000000;  UsedBlocks->Add(b_55);
	auto b_56 = make(600, FVector(24, 3, 11), FVector(5, 1, 4), FRotator(0, 90, 0), -1, ""); b_56.HasElectricityData = true; b_56.ElectricityInfo.CurrentObjectEnergy = 8000.000000;  UsedBlocks->Add(b_56);
	auto b_57 = make(600, FVector(24, 3, 15), FVector(5, 1, 4), FRotator(0, 90, 0), -1, ""); b_57.HasElectricityData = true; b_57.ElectricityInfo.CurrentObjectEnergy = 8000.000000;  UsedBlocks->Add(b_57);
	auto b_58 = make(1000, FVector(23, -20, 12), FVector(1, 1, 1), FRotator(0, 90, 90), -1, "stena"); b_58.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1")); b_58.BlockSpecificData.Add(TEXT("IsOn"), TEXT("1"));
	...
	auto b_59 = make(1150, FVector(-12, 2, 4), FVector(3, 3, 2), FRotator(0, 0, 0), -1, ""); b_59.HasElectricityData = true; b_59.ElectricityInfo.CurrentObjectEnergy = 18000.000000;  UsedBlocks->Add(b_59);
	auto b_60 = make(1150, FVector(-12, -1, 4), FVector(3, 3, 2), FRotator(0, 0, 0), -1, ""); b_60.HasElectricityData = true; b_60.ElectricityInfo.CurrentObjectEnergy = 18000.000000;  UsedBlocks->Add(b_60);
	auto b_61 = make(1150, FVector(-9, 2, 4), FVector(3, 3, 2), FRotator(0, 0, 0), -1, ""); b_61.HasElectricityData = true; b_61.ElectricityInfo.CurrentObjectEnergy = 18000.000000;  UsedBlocks->Add(b_61);
	auto b_62 = make(1150, FVector(-9, -1, 4), FVector(3, 3, 2), FRotator(0, 0, 0), -1, ""); b_62.HasElectricityData = true; b_62.ElectricityInfo.CurrentObjectEnergy = 18000.000000;  UsedBlocks->Add(b_62);
	auto b_63 = make(1200, FVector(22, -29, 5), FVector(3, 3, 3), FRotator(0, -90, 0), -1, ""); b_63.HasElectricityData = true; b_63.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_63);
	auto b_64 = make(1200, FVector(19, -29, 5), FVector(3, 3, 3), FRotator(0, -90, 0), -1, ""); b_64.HasElectricityData = true; b_64.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_64);
	auto b_65 = make(1200, FVector(16, -29, 5), FVector(3, 3, 3), FRotator(0, -90, 0), -1, ""); b_65.HasElectricityData = true; b_65.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_65);
	auto b_66 = make(1200, FVector(13, -29, 5), FVector(3, 3, 3), FRotator(0, -90, 0), -1, ""); b_66.HasElectricityData = true; b_66.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_66);
	auto b_67 = make(1200, FVector(22, -29, 8), FVector(3, 3, 3), FRotator(0, -90, 0), -1, ""); b_67.HasElectricityData = true; b_67.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_67);
	auto b_68 = make(1200, FVector(19, -29, 8), FVector(3, 3, 3), FRotator(0, -90, 0), -1, ""); b_68.HasElectricityData = true; b_68.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_68);
	auto b_69 = make(1200, FVector(22, -23, 5), FVector(3, 3, 3), FRotator(0, -90, 0), -1, ""); b_69.HasElectricityData = true; b_69.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_69);
	auto b_70 = make(1200, FVector(22, -23, 8), FVector(3, 3, 3), FRotator(0, -90, 0), -1, ""); b_70.HasElectricityData = true; b_70.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_70);
	auto b_71 = make(1200, FVector(22, -20, 5), FVector(3, 3, 3), FRotator(0, -90, 0), -1, ""); b_71.HasElectricityData = true; b_71.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_71);
	auto b_72 = make(1200, FVector(22, -20, 8), FVector(3, 3, 3), FRotator(0, -90, 0), -1, ""); b_72.HasElectricityData = true; b_72.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_72);
	auto b_73 = make(1200, FVector(22, -17, 5), FVector(3, 3, 3), FRotator(0, -90, 0), -1, ""); b_73.HasElectricityData = true; b_73.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_73);
	auto b_74 = make(1200, FVector(22, -17, 8), FVector(3, 3, 3), FRotator(0, -90, 0), -1, ""); b_74.HasElectricityData = true; b_74.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_74);
	auto b_75 = make(1200, FVector(22, -14, 5), FVector(3, 3, 3), FRotator(0, 0, 0), -1, ""); b_75.HasElectricityData = true; b_75.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_75);
	auto b_76 = make(1200, FVector(22, -14, 8), FVector(3, 3, 3), FRotator(0, 0, 0), -1, ""); b_76.HasElectricityData = true; b_76.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_76);
	auto b_77 = make(1400, FVector(22, -10, 5), FVector(4, 3, 4), FRotator(0, 90, 0), -1, "Plnicka"); b_77.BlockSpecificData.Add(TEXT("CurrentFilling"), TEXT("0.0")); b_77.BlockSpecificData.Add(TEXT("HasItem"), TEXT("0"));
	...
	auto b_78 = make(1050, FVector(23, -11, 11), FVector(1, 1, 1), FRotator(0, 90, 90), -1, "Vypinac plnicka"); b_78.BlockSpecificData.Add(TEXT("IsON"), TEXT("1"));
	...
	auto b_81 = make(101, FVector(-5, -42, 16), FVector(20, 5, 3), FRotator(0, -180, 0), -1, ""); b_81.HasElectricityData = true; b_81.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_81);
	auto b_82 = make(101, FVector(15, -42, 16), FVector(20, 5, 3), FRotator(0, -180, 0), -1, ""); b_82.HasElectricityData = true; b_82.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_82);
	auto b_83 = make(101, FVector(27, -29, 16), FVector(20, 5, 3), FRotator(0, -90, 0), -1, ""); b_83.HasElectricityData = true; b_83.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_83);
	auto b_84 = make(101, FVector(-18, -30, 16), FVector(20, 5, 3), FRotator(0, 90, 0), -1, ""); b_84.HasElectricityData = true; b_84.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_84);
	auto b_85 = make(101, FVector(-18, -10, 16), FVector(20, 5, 3), FRotator(0, 90, 0), -1, ""); b_85.HasElectricityData = true; b_85.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_85);
	auto b_86 = make(101, FVector(-18, 10, 16), FVector(20, 5, 3), FRotator(0, 90, 0), -1, ""); b_86.HasElectricityData = true; b_86.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_86);
	auto b_87 = make(201, FVector(-18, -42, 16), FVector(5, 5, 3), FRotator(0, -180, 0), -1, ""); b_87.HasElectricityData = true; b_87.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_87);
	auto b_88 = make(201, FVector(27, -42, 16), FVector(5, 5, 3), FRotator(0, -90, 0), -1, ""); b_88.HasElectricityData = true; b_88.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_88);
	auto b_89 = make(201, FVector(27, -17, 16), FVector(5, 5, 3), FRotator(0, 0, 0), -1, ""); b_89.HasElectricityData = true; b_89.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_89);
	auto b_90 = make(201, FVector(-18, 23, 16), FVector(5, 5, 3), FRotator(0, 90, 0), -1, ""); b_90.HasElectricityData = true; b_90.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_90);
	auto b_91 = make(101, FVector(-6, 23, 16), FVector(20, 5, 3), FRotator(0, 0, 0), -1, ""); b_91.HasElectricityData = true; b_91.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_91);
	auto b_92 = make(101, FVector(14, 23, 16), FVector(20, 5, 3), FRotator(0, 0, 0), -1, ""); b_92.HasElectricityData = true; b_92.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_92);
	auto b_93 = make(201, FVector(27, 23, 16), FVector(5, 5, 3), FRotator(0, 0, 0), -1, ""); b_93.HasElectricityData = true; b_93.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_93);
	...
	auto b_95 = make(600, FVector(7, -31, 13), FVector(8, 1, 6), FRotator(90, 0, -180), -1, ""); b_95.HasElectricityData = true; b_95.ElectricityInfo.CurrentObjectEnergy = 19200.000000;  UsedBlocks->Add(b_95);
	auto b_96 = make(1050, FVector(11, -32, 10), FVector(1, 1, 1), FRotator(0, -180, 90), -1, ""); b_96.BlockSpecificData.Add(TEXT("IsON"), TEXT("1"));
	...
	auto b_97 = make(1000, FVector(32, -24, 0), FVector(1, 1, 1), FRotator(0, 90, 0), -1, ""); b_97.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1")); b_97.BlockSpecificData.Add(TEXT("IsOn"), TEXT("0"));
	b_97.HasElectricityData = true; b_97.ElectricityInfo.CurrentObjectEnergy = 0.000000;
	...
	c->PlayerRotation = FRotator(0, 34, 0);
...
USaveGameCarrier* UNewGameSaveHolder::getMiniLevelGameSave(bool full)
{
	...
	auto b_0 = make(0, FVector(-146, 12, 1), FVector(15, 15, 4), FRotator(0, -180, 0), -1, ""); b_0.HasElectricityData = true; b_0.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_0);
	auto b_1 = make(700, FVector(-142, 9, 9), FVector(7, 7, 11), FRotator(0, 90, 0), -1, ""); b_1.AdditionalFlags.Add(TEXT("DoorOpening"), 0);
	...
	auto b_2 = make(1150, FVector(-150, 8, 4), FVector(3, 3, 2), FRotator(0, -90, 0), -1, ""); b_2.HasElectricityData = true; b_2.ElectricityInfo.CurrentObjectEnergy = 18000.000000;  UsedBlocks->Add(b_2);
	auto b_3 = make(2, FVector(-150, 10, 6), FVector(5, 4, 1), FRotator(-90, 0, -90), -1, "");  UsedBlocks->Add(b_3);
	auto b_4 = make(2, FVector(-148, 7, 6), FVector(5, 4, 1), FRotator(-90, 0, 0), -1, "");  UsedBlocks->Add(b_4);
	auto b_5 = make(2, FVector(-150, 6, 6), FVector(5, 4, 1), FRotator(-90, 0, 90), -1, "");  UsedBlocks->Add(b_5);
	auto b_6 = make(2, FVector(-152, 9, 6), FVector(5, 4, 1), FRotator(-90, 0, -180), -1, "");  UsedBlocks->Add(b_6);
	auto b_7 = make(2, FVector(-150, 8, 9), FVector(5, 5, 1), FRotator(0, -90, 0), -1, "");	UsedBlocks->Add(b_7);
	auto b_8 = make(500, FVector(-152, 10, 12), FVector(1, 1, 1), FRotator(0, -180, 0), -1, ""); b_8.HasElectricityData = true; b_8.ElectricityInfo.CurrentObjectEnergy = 100000.000000;  UsedBlocks->Add(b_8);
	auto b_9 = make(1, FVector(-153, 12, 9), FVector(14, 1, 11), FRotator(0, 90, 0), -1, ""); b_9.HasElectricityData = true; b_9.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_9);
	auto b_10 = make(1, FVector(-139, 13, 9), FVector(1, 1, 11), FRotator(0, 90, 0), -1, ""); b_10.HasElectricityData = true; b_10.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_10);
	auto b_11 = make(1, FVector(-139, 19, 9), FVector(1, 1, 11), FRotator(0, 90, 0), -1, ""); b_11.HasElectricityData = true; b_11.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_11);
	auto b_12 = make(1, FVector(-139, 5, 9), FVector(1, 1, 11), FRotator(0, 90, 0), -1, ""); b_12.HasElectricityData = true; b_12.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_12);
	auto b_13 = make(1, FVector(-150, 5, 9), FVector(6, 1, 11), FRotator(0, -180, 0), -1, ""); b_13.HasElectricityData = true; b_13.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_13);
	auto b_14 = make(600, FVector(-146, 19, 9), FVector(13, 1, 11), FRotator(0, 0, 0), -1, ""); b_14.HasElectricityData = true; b_14.ElectricityInfo.CurrentObjectEnergy = 57200.000000;  UsedBlocks->Add(b_14);
	auto b_15 = make(600, FVector(-139, 16, 9), FVector(5, 1, 11), FRotator(0, -90, 0), -1, ""); b_15.HasElectricityData = true; b_15.ElectricityInfo.CurrentObjectEnergy = 22000.000000;  UsedBlocks->Add(b_15);
	auto b_16 = make(600, FVector(-143, 5, 9), FVector(8, 1, 11), FRotator(0, -180, 0), -1, ""); b_16.HasElectricityData = true; b_16.ElectricityInfo.CurrentObjectEnergy = 35200.000000;  UsedBlocks->Add(b_16);
	auto b_17 = make(1100, FVector(-146, 12, 15), FVector(15, 15, 2), FRotator(0, 180, 0), -1, ""); b_17.HasElectricityData = true; b_17.ElectricityInfo.CurrentObjectEnergy = 89895.437500;  UsedBlocks->Add(b_17);
	auto b_18 = make(1050, FVector(-140, 13, 11), FVector(1, 1, 1), FRotator(90, 0, 0), -1, ""); b_18.BlockSpecificData.Add(TEXT("IsON"), TEXT("1"));
	...
	auto b_19 = make(1000, FVector(-148, 7, 14), FVector(1, 1, 1), FRotator(0, -90, -180), -1, ""); b_19.BlockSpecificData.Add(TEXT("IsON"), TEXT("1")); b_19.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0"));
	b_19.HasElectricityData = true; b_19.ElectricityInfo.CurrentObjectEnergy = 1991.448120;
	...
	auto b_20 = make(1000, FVector(-152, 18, 14), FVector(1, 1, 1), FRotator(0, -90, -180), -1, ""); b_20.BlockSpecificData.Add(TEXT("IsON"), TEXT("1")); b_20.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0"));
	b_20.HasElectricityData = true; b_20.ElectricityInfo.CurrentObjectEnergy = 1965.513062;
	...
	auto b_21 = make(1000, FVector(-140, 18, 14), FVector(1, 1, 1), FRotator(0, -90, -180), -1, ""); b_21.BlockSpecificData.Add(TEXT("IsON"), TEXT("1")); b_21.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0"));
	b_21.HasElectricityData = true; b_21.ElectricityInfo.CurrentObjectEnergy = 1931.026733;
	...
	auto b_22 = make(1200, FVector(-151, 17, 5), FVector(3, 3, 3), FRotator(0, 90, 0), -1, ""); b_22.HasElectricityData = true; b_22.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_22);
	auto b_23 = make(1200, FVector(-151, 14, 5), FVector(3, 3, 3), FRotator(0, 90, 0), -1, ""); b_23.HasElectricityData = true; b_23.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_23);
	auto b_24 = make(1200, FVector(-151, 17, 8), FVector(3, 3, 3), FRotator(0, 90, 0), -1, ""); b_24.HasElectricityData = true; b_24.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_24);
	auto b_25 = make(1200, FVector(-151, 14, 8), FVector(3, 3, 3), FRotator(0, 90, 0), -1, ""); b_25.HasElectricityData = true; b_25.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_25);
	auto b_26 = make(1500, FVector(-151, 12, 4), FVector(2, 2, 2), FRotator(0, -180, 0), -1, ""); b_26.HasOxygenData = true; b_26.OxygenInfo.CurrentObjectOxygen = 10.000000;  UsedBlocks->Add(b_26);
	auto b_27 = make(1500, FVector(-151, 12, 6), FVector(2, 2, 2), FRotator(0, 180, 0), -1, ""); b_27.HasOxygenData = true; b_27.OxygenInfo.CurrentObjectOxygen = 10.000000;  UsedBlocks->Add(b_27);
	auto b_28 = make(1500, FVector(-151, 12, 8), FVector(2, 2, 2), FRotator(0, 180, 0), -1, ""); b_28.HasOxygenData = true; b_28.OxygenInfo.CurrentObjectOxygen = 10.000000;  UsedBlocks->Add(b_28);
	auto b_29 = make(1500, FVector(-140, 17, 4), FVector(2, 2, 2), FRotator(0, 90, 0), -1, ""); b_29.HasOxygenData = true; b_29.OxygenInfo.CurrentObjectOxygen = 10.000000;  UsedBlocks->Add(b_29);
	auto b_30 = make(1500, FVector(-142, 17, 4), FVector(2, 2, 2), FRotator(0, 90, 0), -1, ""); b_30.HasOxygenData = true; b_30.OxygenInfo.CurrentObjectOxygen = 10.000000;  UsedBlocks->Add(b_30);
	auto b_31 = make(1500, FVector(-140, 17, 6), FVector(2, 2, 2), FRotator(0, 90, 0), -1, ""); b_31.HasOxygenData = true; b_31.OxygenInfo.CurrentObjectOxygen = 10.000000;  UsedBlocks->Add(b_31);
	auto b_32 = make(1500, FVector(-142, 17, 6), FVector(2, 2, 2), FRotator(0, 90, 0), -1, ""); b_32.HasOxygenData = true; b_32.OxygenInfo.CurrentObjectOxygen = 10.000000;  UsedBlocks->Add(b_32);
	auto b_33 = make(1500, FVector(-140, 17, 8), FVector(2, 2, 2), FRotator(0, 90, 0), -1, ""); b_33.HasOxygenData = true; b_33.OxygenInfo.CurrentObjectOxygen = 10.000000;  UsedBlocks->Add(b_33);
	auto b_34 = make(1500, FVector(-142, 17, 8), FVector(2, 2, 2), FRotator(0, 90, 0), -1, ""); b_34.HasOxygenData = true; b_34.OxygenInfo.CurrentObjectOxygen = 10.000000;  UsedBlocks->Add(b_34);
	c->PlayerPosition = FVector(-2830, 157, 163);
	c->PlayerRotation = FRotator(0, 139, 0);
