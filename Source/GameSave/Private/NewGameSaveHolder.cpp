...
USaveGameCarrier* UNewGameSaveHolder::getDefaultGameSave(bool full)
{
	...
	auto b_12 = make(1000, FVector(19, -32, 8), FVector(1, 1, 1), FRotator(0, 0, -90), 1000, ""); b_12.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1"));
	...
	auto b_13 = make(1000, FVector(25, -13, 8), FVector(1, 1, 1), FRotator(0, 90, -90), 1000, ""); b_13.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1"));
	...
	auto b_14 = make(1000, FVector(13, 9, 3), FVector(1, 1, 1), FRotator(0, -180, -90), 1000, ""); b_14.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1"));
	...
	auto b_15 = make(1000, FVector(-16, -10, 2), FVector(1, 1, 1), FRotator(0, -90, -90), 1000, ""); b_15.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1"));
	...
	auto b_16 = make(1000, FVector(4, -6, 4), FVector(1, 1, 1), FRotator(0, 90, 0), 1000, "na zemi"); b_16.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1"));
	...
	auto b_17 = make(1000, FVector(-11, -19, 4), FVector(1, 1, 1), FRotator(0, 90, 0), 1000, "Skoro venku"); b_17.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1"));
	...
	b_17.RelationshipInfo.Relationships.Add(b_17_rel0);
	FRelationshipInfo b_17_rel1; FGuid b_17_rel1_id; FGuid::Parse("6EEA645949C55B8F90F421AB704204C1", b_17_rel1_id); b_17_rel1.TargetID = b_17_rel1_id; b_17_rel1.RelationshipType = 0;
	b_17.RelationshipInfo.Relationships.Add(b_17_rel1); UsedBlocks->Add(b_17);
	...
	b_19.BlockSpecificData.Add(TEXT("DoorState"), TEXT("2")); b_19.BlockSpecificData.Add(TEXT("DoorYaw"), TEXT("89.999992"));
	...
	auto b_47 = make(1100, FVector(-9, 38, 0), FVector(20, 20, 2), FRotator(0, 0, 0), 1100, ""); b_47.HasElectricityData = true; b_47.ElectricityInfo.CurrentObjectEnergy = 159647.000000;  UsedBlocks->Add(b_47);
	...
	auto b_62 = make(1000, FVector(23, -20, 12), FVector(1, 1, 1), FRotator(0, 90, 90), 1000, ""); b_62.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0"));
	...
	auto b_86 = make(1050, FVector(23, -11, 11), FVector(1, 1, 1), FRotator(0, 90, 90), 1050, "Vypinac plnicka"); b_86.BlockSpecificData.Add(TEXT("IsON"), TEXT("0"));
	...
	b_86.RelationshipInfo.Relationships.Add(b_86_rel1); UsedBlocks->Add(b_86);
	c->PlayerPosition = FVector(305, -328, 163);
	c->PlayerRotation = FRotator(0, -28, 0);
