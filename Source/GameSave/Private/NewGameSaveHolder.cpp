...
USaveGameCarrier* UNewGameSaveHolder::getTutorialGameSave(bool full)
{
	...
	auto b_107 = make1(1, -15, 1, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_107, 0.000000); UsedBlocks->Add(b_107);
	auto b_108 = make1(2, -12, -21, 9, 1, 1, 11, 0, -180, 0, 110.000000, ""); UsedBlocks->Add(b_108);
	auto b_109 = make1(2, -7, -21, 9, 1, 1, 11, 0, -180, 0, 110.000000, ""); UsedBlocks->Add(b_109);
	auto b_110 = make1(2, -1, -21, 9, 1, 1, 11, 0, -180, 0, 110.000000, ""); UsedBlocks->Add(b_110);
	auto b_111 = make1(2, -4, -11, 9, 1, 1, 11, 0, -180, 0, 110.000000, ""); UsedBlocks->Add(b_111);
	auto b_112 = make1(2, -4, -16, 9, 1, 1, 11, 0, -180, 0, 110.000000, ""); UsedBlocks->Add(b_112);
	auto b_113 = make1(2, -4, -14, 9, 1, 1, 11, 0, -180, 0, 110.000000, ""); UsedBlocks->Add(b_113);
	auto b_114 = make1(2, -4, -18, 9, 1, 1, 11, 0, -180, 0, 110.000000, ""); UsedBlocks->Add(b_114);
	auto b_115 = make1(2, -4, 4, 9, 1, 1, 11, 0, -180, 0, 110.000000, ""); UsedBlocks->Add(b_115);
	auto b_116 = make1(2, -4, 7, 9, 1, 1, 11, 0, -180, 0, 110.000000, ""); UsedBlocks->Add(b_116);
	auto b_117 = make1(2, -4, 10, 9, 1, 1, 11, 0, -180, 0, 110.000000, ""); UsedBlocks->Add(b_117);
	auto b_118 = make1(2, -4, 13, 9, 1, 1, 11, 0, -180, 0, 110.000000, ""); UsedBlocks->Add(b_118);
	auto b_119 = make1(2, -4, 15, 9, 1, 1, 11, 0, -180, 0, 110.000000, ""); UsedBlocks->Add(b_119);
	auto b_120 = make1(2, -15, -2, 9, 1, 1, 11, 0, -180, 0, 110.000000, ""); UsedBlocks->Add(b_120);
	auto b_121 = make1(2, -15, -4, 9, 1, 1, 11, 0, -180, 0, 110.000000, ""); UsedBlocks->Add(b_121);
	auto b_122 = make1(700, -7, -3, 9, 7, 7, 11, 0, 90, 0, 10.000000, ""); af(b_122, TEXT("DoorOpening"), 1); bd(b_122, TEXT("DoorState"), TEXT("0")); bd(b_122, TEXT("DoorYaw"), TEXT("0.0")); mE(b_122, 0.000000); UsedBlocks->Add(b_122);
	auto b_123 = make1(1, -35, -21, 9, 1, 1, 11, 0, -90, 0, 110.000000, ""); mE(b_123, 57200.000000); UsedBlocks->Add(b_123);
	auto b_124 = make1(1, -35, 18, 9, 1, 1, 11, 0, -90, 0, 110.000000, ""); mE(b_124, 57200.000000); UsedBlocks->Add(b_124);
	auto b_125 = make1(1, -35, -1, 9, 2, 1, 11, 0, -90, 0, 220.000000, ""); mE(b_125, 57200.000000); UsedBlocks->Add(b_125);
	auto b_126 = make1(1, -16, 18, 9, 2, 1, 11, 0, 0, 0, 220.000000, ""); mE(b_126, 57200.000000); UsedBlocks->Add(b_126);
	auto b_127 = make1(600, -25, -21, 9, 19, 1, 11, 0, 0, 0, 2090.000000, ""); mE(b_127, 57200.000000); UsedBlocks->Add(b_127);
	auto b_128 = make1(600, -35, -11, 9, 18, 1, 11, 0, -90, 0, 1980.000000, ""); mE(b_128, 57200.000000); UsedBlocks->Add(b_128);
	auto b_129 = make1(600, -35, 9, 9, 18, 1, 11, 0, -90, 0, 1980.000000, ""); mE(b_129, 57200.000000); UsedBlocks->Add(b_129);
	auto b_130 = make1(600, -25, 18, 9, 18, 1, 11, 0, -180, 0, 1980.000000, ""); mE(b_130, 57200.000000); UsedBlocks->Add(b_130);
	auto b_131 = make1(600, -9, 18, 9, 10, 1, 11, 0, -180, 0, 1100.000000, ""); mE(b_131, 57200.000000); UsedBlocks->Add(b_131);
	auto b_132 = make1(600, -10, 1, 9, 10, 1, 11, 0, 0, 0, 1100.000000, ""); mE(b_132, 57200.000000); UsedBlocks->Add(b_132);
	auto b_133 = make1(600, 0, 18, 9, 7, 1, 11, 0, -180, 0, 770.000000, ""); mE(b_133, 57200.000000); UsedBlocks->Add(b_133);
