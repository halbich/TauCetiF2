...
USaveGameCarrier* UNewGameSaveHolder::getDefaultGameSave(bool full)
{
	...
	auto b_16 = make(1000, FVector(4, -6, 4), FVector(1, 1, 1), FRotator(0, 90, 0), 1000, "na zemi"); b_16.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1")); b_16.BlockSpecificData.Add(TEXT("IsOn"), TEXT("0"));
	b_16.HasElectricityData = true; b_16.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	...
	auto b_17 = make(1000, FVector(-11, -19, 4), FVector(1, 1, 1), FRotator(0, 90, 0), 1000, "Skoro venku"); b_17.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1")); b_17.BlockSpecificData.Add(TEXT("IsOn"), TEXT("0"));
	b_17.HasElectricityData = true; b_17.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	...
	FRelationshipInfo b_17_rel0; FGuid b_17_rel0_id; FGuid::Parse("6EEA645949C55B8F90F421AB704204C1", b_17_rel0_id); b_17_rel0.TargetID = b_17_rel0_id; b_17_rel0.RelationshipType = 0;
	...
	auto b_19 = make(700, FVector(0, -35, 9), FVector(7, 7, 11), FRotator(0, 90, 0), 700, ""); b_19.AdditionalFlags.Add(TEXT("DoorOpening"), 0);
	b_19.BlockSpecificData.Add(TEXT("DoorState"), TEXT("2")); b_19.BlockSpecificData.Add(TEXT("DoorYaw"), TEXT("89.0"));
	b_19.HasElectricityData = true; b_19.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_19);
	...
	auto b_54 = make(1050, FVector(-3, -9, 4), FVector(1, 1, 1), FRotator(0, 90, 0), 1050, "Tlacitko na zemi"); b_54.BlockSpecificData.Add(TEXT("IsON"), TEXT("0"));
	b_54.HasElectricityData = true; b_54.ElectricityInfo.CurrentObjectEnergy = 0.000000;
	...
	b_54.RelationshipInfo.Relationships.Add(b_54_rel1); UsedBlocks->Add(b_54);
	...
	auto b_62 = make(1000, FVector(23, -20, 12), FVector(1, 1, 1), FRotator(0, 90, 90), 1000, "stena"); b_62.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0")); b_62.BlockSpecificData.Add(TEXT("IsOn"), TEXT("0"));
	b_62.HasElectricityData = true; b_62.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	b_62.HasRelationshipData = true; FGuid b_62_rel_id; FGuid::Parse("053D69F542E0BAEAD45D9D9ED75F3844", b_62_rel_id); b_62.RelationshipInfo.ID = b_62_rel_id;
	FRelationshipInfo b_62_rel0; FGuid b_62_rel0_id; FGuid::Parse("6EEA645949C55B8F90F421AB704204C1", b_62_rel0_id); b_62_rel0.TargetID = b_62_rel0_id; b_62_rel0.RelationshipType = 0;
	b_62.RelationshipInfo.Relationships.Add(b_62_rel0); UsedBlocks->Add(b_62);
	auto b_63 = make(1150, FVector(-12, 2, 4), FVector(3, 3, 2), FRotator(0, 0, 0), 1150, ""); b_63.HasElectricityData = true; b_63.ElectricityInfo.CurrentObjectEnergy = 18000.000000;  UsedBlocks->Add(b_63);
	auto b_64 = make(1150, FVector(-12, -1, 4), FVector(3, 3, 2), FRotator(0, 0, 0), 1150, ""); b_64.HasElectricityData = true; b_64.ElectricityInfo.CurrentObjectEnergy = 18000.000000;  UsedBlocks->Add(b_64);
	auto b_65 = make(1150, FVector(-9, 2, 4), FVector(3, 3, 2), FRotator(0, 0, 0), 1150, ""); b_65.HasElectricityData = true; b_65.ElectricityInfo.CurrentObjectEnergy = 18000.000000;  UsedBlocks->Add(b_65);
	auto b_66 = make(1150, FVector(-9, -1, 4), FVector(3, 3, 2), FRotator(0, 0, 0), 1150, ""); b_66.HasElectricityData = true; b_66.ElectricityInfo.CurrentObjectEnergy = 18000.000000;  UsedBlocks->Add(b_66);
	...
	auto b_85 = make(1400, FVector(22, -10, 5), FVector(4, 3, 4), FRotator(0, 90, 0), 1400, "Plnicka"); b_85.HasElectricityData = true; b_85.ElectricityInfo.CurrentObjectEnergy = 150.000000; b_85.HasOxygenData = true; b_85.OxygenInfo.CurrentObjectOxygen = 150.000000;
	b_85.HasRelationshipData = true; FGuid b_85_rel_id; FGuid::Parse("A9F299C54AB0F2B6ABEBC280C23BF218", b_85_rel_id); b_85.RelationshipInfo.ID = b_85_rel_id;
	FRelationshipInfo b_85_rel0; FGuid b_85_rel0_id; FGuid::Parse("6EEA645949C55B8F90F421AB704204C1", b_85_rel0_id); b_85_rel0.TargetID = b_85_rel0_id; b_85_rel0.RelationshipType = 0;
	b_85.RelationshipInfo.Relationships.Add(b_85_rel0); UsedBlocks->Add(b_85);
	auto b_86 = make(1050, FVector(23, -11, 11), FVector(1, 1, 1), FRotator(0, 90, 90), 1050, "Vypinac plnicka"); b_86.BlockSpecificData.Add(TEXT("IsON"), TEXT("1"));
	b_86.HasElectricityData = true; b_86.ElectricityInfo.CurrentObjectEnergy = 0.000000;
	b_86.HasRelationshipData = true; FGuid b_86_rel_id; FGuid::Parse("6EEA645949C55B8F90F421AB704204C1", b_86_rel_id); b_86.RelationshipInfo.ID = b_86_rel_id;
	FRelationshipInfo b_86_rel0; FGuid b_86_rel0_id; FGuid::Parse("A9F299C54AB0F2B6ABEBC280C23BF218", b_86_rel0_id); b_86_rel0.TargetID = b_86_rel0_id; b_86_rel0.RelationshipType = 1;
	b_86.RelationshipInfo.Relationships.Add(b_86_rel0);
	FRelationshipInfo b_86_rel1; FGuid b_86_rel1_id; FGuid::Parse("A1257C2E414F1607AB4F99A2E04D6E94", b_86_rel1_id); b_86_rel1.TargetID = b_86_rel1_id; b_86_rel1.RelationshipType = 1;
	b_86.RelationshipInfo.Relationships.Add(b_86_rel1);
	FRelationshipInfo b_86_rel2; FGuid b_86_rel2_id; FGuid::Parse("053D69F542E0BAEAD45D9D9ED75F3844", b_86_rel2_id); b_86_rel2.TargetID = b_86_rel2_id; b_86_rel2.RelationshipType = 1;
	b_86.RelationshipInfo.Relationships.Add(b_86_rel2); UsedBlocks->Add(b_86);
	c->PlayerPosition = FVector(317, -244, 163);
