...
USaveGameCarrier* UNewGameSaveHolder::getDefaultGameSave(bool full)
{
	...
	auto b_12 = make(1000, FVector(19, -32, 8), FVector(1, 1, 1), FRotator(0, 0, -90), 1000, ""); b_12.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1")); b_12.BlockSpecificData.Add(TEXT("IsOn"), TEXT("0"));
	...
	auto b_13 = make(1000, FVector(25, -13, 8), FVector(1, 1, 1), FRotator(0, 90, -90), 1000, ""); b_13.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1")); b_13.BlockSpecificData.Add(TEXT("IsOn"), TEXT("0"));
	...
	auto b_14 = make(1000, FVector(13, 9, 3), FVector(1, 1, 1), FRotator(0, -180, -90), 1000, ""); b_14.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1")); b_14.BlockSpecificData.Add(TEXT("IsOn"), TEXT("0"));
	...
	auto b_15 = make(1000, FVector(-16, -10, 2), FVector(1, 1, 1), FRotator(0, -90, -90), 1000, ""); b_15.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("1")); b_15.BlockSpecificData.Add(TEXT("IsOn"), TEXT("0"));
	b_15.HasElectricityData = true; b_15.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	...
	auto b_16 = make(0, FVector(-6, -35, 1), FVector(19, 8, 4), FRotator(0, 180, 0), 0, ""); b_16.HasElectricityData = true; b_16.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_16);
	auto b_17 = make(700, FVector(0, -35, 9), FVector(7, 7, 11), FRotator(0, 90, 0), 700, ""); b_17.AdditionalFlags.Add(TEXT("DoorOpening"), 0);
	b_17.BlockSpecificData.Add(TEXT("DoorState"), TEXT("2")); b_17.BlockSpecificData.Add(TEXT("DoorYaw"), TEXT("89.0"));
	b_17.HasElectricityData = true; b_17.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_17);
	auto b_18 = make(1, FVector(3, -39, 9), FVector(1, 1, 11), FRotator(0, 0, 0), 1, ""); b_18.HasElectricityData = true; b_18.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_18);
	auto b_19 = make(600, FVector(0, -39, 9), FVector(6, 1, 11), FRotator(0, -180, 0), 600, ""); b_19.HasElectricityData = true; b_19.ElectricityInfo.CurrentObjectEnergy = 26400.000000;  UsedBlocks->Add(b_19);
	auto b_20 = make(600, FVector(-6, -39, 9), FVector(5, 1, 11), FRotator(0, 0, 0), 600, ""); b_20.HasElectricityData = true; b_20.ElectricityInfo.CurrentObjectEnergy = 22000.000000;  UsedBlocks->Add(b_20);
	auto b_21 = make(2, FVector(4, -27, 4), FVector(2, 7, 1), FRotator(0, 0, 0), 2, "");  UsedBlocks->Add(b_21);
	auto b_22 = make(2, FVector(6, -27, 5), FVector(2, 7, 1), FRotator(0, 0, 0), 2, "");  UsedBlocks->Add(b_22);
	auto b_23 = make(2, FVector(8, -27, 6), FVector(2, 7, 1), FRotator(0, 0, 0), 2, "");  UsedBlocks->Add(b_23);
	auto b_24 = make(2, FVector(10, -27, 7), FVector(2, 7, 1), FRotator(0, 0, 0), 2, "");  UsedBlocks->Add(b_24);
	auto b_25 = make(2, FVector(12, -27, 8), FVector(2, 7, 1), FRotator(0, 0, 0), 2, "");  UsedBlocks->Add(b_25);
	auto b_26 = make(2, FVector(14, -27, 9), FVector(2, 7, 1), FRotator(0, 0, 0), 2, "");  UsedBlocks->Add(b_26);
	auto b_27 = make(1, FVector(21, -31, 13), FVector(8, 7, 1), FRotator(90, 0, 90), 1, ""); b_27.HasElectricityData = true; b_27.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_27);
	auto b_28 = make(1, FVector(14, -31, 13), FVector(8, 7, 1), FRotator(90, 0, 90), 1, ""); b_28.HasElectricityData = true; b_28.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_28);
	auto b_29 = make(1, FVector(24, -27, 13), FVector(8, 7, 1), FRotator(90, 0, -180), 1, ""); b_29.HasElectricityData = true; b_29.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_29);
	auto b_30 = make(1, FVector(24, -20, 13), FVector(8, 7, 1), FRotator(90, 0, -180), 1, ""); b_30.HasElectricityData = true; b_30.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_30);
	auto b_31 = make(2, FVector(16, -27, 10), FVector(2, 7, 1), FRotator(0, 0, 0), 2, "");  UsedBlocks->Add(b_31);
	auto b_32 = make(1, FVector(20, -27, 10), FVector(6, 6, 1), FRotator(0, -90, 0), 1, ""); b_32.HasElectricityData = true; b_32.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_32);
	auto b_33 = make(2, FVector(20, -23, 11), FVector(2, 7, 1), FRotator(0, -90, 0), 2, "");  UsedBlocks->Add(b_33);
	auto b_34 = make(2, FVector(20, -21, 12), FVector(2, 7, 1), FRotator(0, -90, 0), 2, "");  UsedBlocks->Add(b_34);
	auto b_35 = make(2, FVector(20, -19, 13), FVector(2, 7, 1), FRotator(0, -90, 0), 2, "");  UsedBlocks->Add(b_35);
	auto b_36 = make(2, FVector(20, -17, 14), FVector(2, 7, 1), FRotator(0, -90, 0), 2, "");  UsedBlocks->Add(b_36);
	auto b_37 = make(1, FVector(24, -13, 14), FVector(8, 7, 1), FRotator(-90, 0, 0), 1, ""); b_37.HasElectricityData = true; b_37.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_37);
	auto b_38 = make(2, FVector(20, -15, 15), FVector(2, 7, 1), FRotator(0, -90, 0), 2, "");  UsedBlocks->Add(b_38);
	auto b_39 = make(2, FVector(20, -13, 16), FVector(2, 7, 1), FRotator(0, -90, 0), 2, "");  UsedBlocks->Add(b_39);
	auto b_40 = make(2, FVector(20, -11, 17), FVector(2, 7, 1), FRotator(0, -90, 0), 2, "");  UsedBlocks->Add(b_40);
	auto b_41 = make(1, FVector(3, -31, 9), FVector(1, 1, 11), FRotator(0, 0, 0), 1, ""); b_41.HasElectricityData = true; b_41.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_41);
	auto b_42 = make(1, FVector(16, -23, 9), FVector(1, 1, 11), FRotator(0, 0, 0), 1, ""); b_42.HasElectricityData = true; b_42.ElectricityInfo.CurrentObjectEnergy = 0.000000;  UsedBlocks->Add(b_42);
	auto b_43 = make(1100, FVector(11, 18, 0), FVector(20, 20, 2), FRotator(0, 0, 0), 1100, ""); b_43.HasElectricityData = true; b_43.ElectricityInfo.CurrentObjectEnergy = 159405.000000;  UsedBlocks->Add(b_43);
	auto b_44 = make(1100, FVector(-9, 18, 0), FVector(20, 20, 2), FRotator(0, 0, 0), 1100, ""); b_44.HasElectricityData = true; b_44.ElectricityInfo.CurrentObjectEnergy = 159709.000000;  UsedBlocks->Add(b_44);
	auto b_45 = make(1100, FVector(-9, 38, 0), FVector(20, 20, 2), FRotator(0, 0, 0), 1100, ""); b_45.HasElectricityData = true; b_45.ElectricityInfo.CurrentObjectEnergy = 159647.000000;  UsedBlocks->Add(b_45);
	auto b_46 = make(1100, FVector(11, 38, 0), FVector(20, 20, 2), FRotator(0, 0, 0), 1100, ""); b_46.HasElectricityData = true; b_46.ElectricityInfo.CurrentObjectEnergy = 159672.000000;  UsedBlocks->Add(b_46);
	auto b_47 = make(1100, FVector(31, 18, 0), FVector(20, 20, 2), FRotator(0, 0, 0), 1100, ""); b_47.HasElectricityData = true; b_47.ElectricityInfo.CurrentObjectEnergy = 159338.000000;  UsedBlocks->Add(b_47);
	auto b_48 = make(1100, FVector(31, 38, 0), FVector(20, 20, 2), FRotator(0, 0, 0), 1100, ""); b_48.HasElectricityData = true; b_48.ElectricityInfo.CurrentObjectEnergy = 159708.000000;  UsedBlocks->Add(b_48);
	auto b_49 = make(1100, FVector(31, 58, 0), FVector(20, 20, 2), FRotator(0, 0, 0), 1100, ""); b_49.HasElectricityData = true; b_49.ElectricityInfo.CurrentObjectEnergy = 159373.000000;  UsedBlocks->Add(b_49);
	auto b_50 = make(1100, FVector(11, 59, 0), FVector(20, 20, 2), FRotator(0, -90, 0), 1100, ""); b_50.HasElectricityData = true; b_50.ElectricityInfo.CurrentObjectEnergy = 159665.000000;  UsedBlocks->Add(b_50);
	auto b_51 = make(1100, FVector(-9, 59, 0), FVector(20, 20, 2), FRotator(0, -90, 0), 1100, ""); b_51.HasElectricityData = true; b_51.ElectricityInfo.CurrentObjectEnergy = 159719.000000;  UsedBlocks->Add(b_51);
	auto b_52 = make(1050, FVector(-3, -9, 4), FVector(1, 1, 1), FRotator(0, 90, 0), 1050, "Tlacitko na zemi"); b_52.BlockSpecificData.Add(TEXT("IsON"), TEXT("0"));
	b_52.HasElectricityData = true; b_52.ElectricityInfo.CurrentObjectEnergy = 0.000000;
	b_52.HasRelationshipData = true; FGuid b_52_rel_id; FGuid::Parse("797CEC8E499C456A5E1C46B8312736AB", b_52_rel_id); b_52.RelationshipInfo.ID = b_52_rel_id;
	FRelationshipInfo b_52_rel0; FGuid b_52_rel0_id; FGuid::Parse("703EFD1844A5E576A5932288A38E20B9", b_52_rel0_id); b_52_rel0.TargetID = b_52_rel0_id; b_52_rel0.RelationshipType = 1;
	b_52.RelationshipInfo.Relationships.Add(b_52_rel0); UsedBlocks->Add(b_52);
	auto b_53 = make(600, FVector(24, -7, 11), FVector(5, 1, 4), FRotator(0, 90, 0), 600, ""); b_53.HasElectricityData = true; b_53.ElectricityInfo.CurrentObjectEnergy = 8000.000000;  UsedBlocks->Add(b_53);
	auto b_54 = make(600, FVector(24, -7, 15), FVector(5, 1, 4), FRotator(0, 90, 0), 600, ""); b_54.HasElectricityData = true; b_54.ElectricityInfo.CurrentObjectEnergy = 8000.000000;  UsedBlocks->Add(b_54);
	auto b_55 = make(600, FVector(24, -2, 11), FVector(5, 1, 4), FRotator(0, 90, 0), 600, ""); b_55.HasElectricityData = true; b_55.ElectricityInfo.CurrentObjectEnergy = 8000.000000;  UsedBlocks->Add(b_55);
	auto b_56 = make(600, FVector(24, -2, 15), FVector(5, 1, 4), FRotator(0, 90, 0), 600, ""); b_56.HasElectricityData = true; b_56.ElectricityInfo.CurrentObjectEnergy = 8000.000000;  UsedBlocks->Add(b_56);
	auto b_57 = make(600, FVector(24, 3, 11), FVector(5, 1, 4), FRotator(0, 90, 0), 600, ""); b_57.HasElectricityData = true; b_57.ElectricityInfo.CurrentObjectEnergy = 8000.000000;  UsedBlocks->Add(b_57);
	auto b_58 = make(600, FVector(24, 3, 15), FVector(5, 1, 4), FRotator(0, 90, 0), 600, ""); b_58.HasElectricityData = true; b_58.ElectricityInfo.CurrentObjectEnergy = 8000.000000;  UsedBlocks->Add(b_58);
	auto b_59 = make(1000, FVector(23, -20, 12), FVector(1, 1, 1), FRotator(0, 90, 90), 1000, "stena"); b_59.BlockSpecificData.Add(TEXT("IsAutoregulated"), TEXT("0")); b_59.BlockSpecificData.Add(TEXT("IsOn"), TEXT("0"));
	b_59.HasElectricityData = true; b_59.ElectricityInfo.CurrentObjectEnergy = 200.000000;
	b_59.HasRelationshipData = true; FGuid b_59_rel_id; FGuid::Parse("053D69F542E0BAEAD45D9D9ED75F3844", b_59_rel_id); b_59.RelationshipInfo.ID = b_59_rel_id;
	FRelationshipInfo b_59_rel0; FGuid b_59_rel0_id; FGuid::Parse("6EEA645949C55B8F90F421AB704204C1", b_59_rel0_id); b_59_rel0.TargetID = b_59_rel0_id; b_59_rel0.RelationshipType = 0;
	b_59.RelationshipInfo.Relationships.Add(b_59_rel0); UsedBlocks->Add(b_59);
	auto b_60 = make(1150, FVector(-12, 2, 4), FVector(3, 3, 2), FRotator(0, 0, 0), 1150, ""); b_60.HasElectricityData = true; b_60.ElectricityInfo.CurrentObjectEnergy = 18000.000000;  UsedBlocks->Add(b_60);
	auto b_61 = make(1150, FVector(-12, -1, 4), FVector(3, 3, 2), FRotator(0, 0, 0), 1150, ""); b_61.HasElectricityData = true; b_61.ElectricityInfo.CurrentObjectEnergy = 18000.000000;  UsedBlocks->Add(b_61);
	auto b_62 = make(1150, FVector(-9, 2, 4), FVector(3, 3, 2), FRotator(0, 0, 0), 1150, ""); b_62.HasElectricityData = true; b_62.ElectricityInfo.CurrentObjectEnergy = 18000.000000;  UsedBlocks->Add(b_62);
	auto b_63 = make(1150, FVector(-9, -1, 4), FVector(3, 3, 2), FRotator(0, 0, 0), 1150, ""); b_63.HasElectricityData = true; b_63.ElectricityInfo.CurrentObjectEnergy = 18000.000000;  UsedBlocks->Add(b_63);
	auto b_64 = make(1200, FVector(22, -29, 5), FVector(3, 3, 3), FRotator(0, -90, 0), 1200, ""); b_64.HasElectricityData = true; b_64.ElectricityInfo.CurrentObjectEnergy = 100000.000000;  UsedBlocks->Add(b_64);
	auto b_65 = make(1200, FVector(19, -29, 5), FVector(3, 3, 3), FRotator(0, -90, 0), 1200, ""); b_65.HasElectricityData = true; b_65.ElectricityInfo.CurrentObjectEnergy = 100000.000000;  UsedBlocks->Add(b_65);
	auto b_66 = make(1200, FVector(16, -29, 5), FVector(3, 3, 3), FRotator(0, -90, 0), 1200, ""); b_66.HasElectricityData = true; b_66.ElectricityInfo.CurrentObjectEnergy = 100000.000000;  UsedBlocks->Add(b_66);
	auto b_67 = make(1200, FVector(13, -29, 5), FVector(3, 3, 3), FRotator(0, -90, 0), 1200, ""); b_67.HasElectricityData = true; b_67.ElectricityInfo.CurrentObjectEnergy = 100000.000000;  UsedBlocks->Add(b_67);
	auto b_68 = make(1200, FVector(22, -29, 8), FVector(3, 3, 3), FRotator(0, -90, 0), 1200, ""); b_68.HasElectricityData = true; b_68.ElectricityInfo.CurrentObjectEnergy = 100000.000000;  UsedBlocks->Add(b_68);
	auto b_69 = make(1200, FVector(19, -29, 8), FVector(3, 3, 3), FRotator(0, -90, 0), 1200, ""); b_69.HasElectricityData = true; b_69.ElectricityInfo.CurrentObjectEnergy = 100000.000000;  UsedBlocks->Add(b_69);
	auto b_70 = make(1200, FVector(22, -23, 5), FVector(3, 3, 3), FRotator(0, -90, 0), 1200, ""); b_70.HasElectricityData = true; b_70.ElectricityInfo.CurrentObjectEnergy = 100000.000000;  UsedBlocks->Add(b_70);
	auto b_71 = make(1200, FVector(22, -23, 8), FVector(3, 3, 3), FRotator(0, -90, 0), 1200, ""); b_71.HasElectricityData = true; b_71.ElectricityInfo.CurrentObjectEnergy = 100000.000000;  UsedBlocks->Add(b_71);
	auto b_72 = make(1200, FVector(22, -20, 5), FVector(3, 3, 3), FRotator(0, -90, 0), 1200, ""); b_72.HasElectricityData = true; b_72.ElectricityInfo.CurrentObjectEnergy = 100000.000000;  UsedBlocks->Add(b_72);
	auto b_73 = make(1200, FVector(22, -20, 8), FVector(3, 3, 3), FRotator(0, -90, 0), 1200, ""); b_73.HasElectricityData = true; b_73.ElectricityInfo.CurrentObjectEnergy = 100000.000000;  UsedBlocks->Add(b_73);
	auto b_74 = make(1200, FVector(22, -17, 5), FVector(3, 3, 3), FRotator(0, -90, 0), 1200, ""); b_74.HasElectricityData = true; b_74.ElectricityInfo.CurrentObjectEnergy = 100000.000000;  UsedBlocks->Add(b_74);
	auto b_75 = make(1200, FVector(22, -17, 8), FVector(3, 3, 3), FRotator(0, -90, 0), 1200, ""); b_75.HasElectricityData = true; b_75.ElectricityInfo.CurrentObjectEnergy = 100000.000000;  UsedBlocks->Add(b_75);
	auto b_76 = make(1200, FVector(22, -14, 5), FVector(3, 3, 3), FRotator(0, 0, 0), 1200, ""); b_76.HasElectricityData = true; b_76.ElectricityInfo.CurrentObjectEnergy = 100000.000000;  UsedBlocks->Add(b_76);
	auto b_77 = make(1200, FVector(22, -14, 8), FVector(3, 3, 3), FRotator(0, 0, 0), 1200, ""); b_77.HasElectricityData = true; b_77.ElectricityInfo.CurrentObjectEnergy = 100000.000000;  UsedBlocks->Add(b_77);
	auto b_78 = make(1400, FVector(22, -10, 5), FVector(4, 3, 4), FRotator(0, 90, 0), 1400, "Plnicka"); b_78.HasElectricityData = true; b_78.ElectricityInfo.CurrentObjectEnergy = 150.000000; b_78.HasOxygenData = true; b_78.OxygenInfo.CurrentObjectOxygen = 150.000000;
	b_78.HasRelationshipData = true; FGuid b_78_rel_id; FGuid::Parse("A9F299C54AB0F2B6ABEBC280C23BF218", b_78_rel_id); b_78.RelationshipInfo.ID = b_78_rel_id;
	FRelationshipInfo b_78_rel0; FGuid b_78_rel0_id; FGuid::Parse("6EEA645949C55B8F90F421AB704204C1", b_78_rel0_id); b_78_rel0.TargetID = b_78_rel0_id; b_78_rel0.RelationshipType = 0;
	b_78.RelationshipInfo.Relationships.Add(b_78_rel0); UsedBlocks->Add(b_78);
	auto b_79 = make(1050, FVector(23, -11, 11), FVector(1, 1, 1), FRotator(0, 90, 90), 1050, "Vypinac plnicka"); b_79.BlockSpecificData.Add(TEXT("IsON"), TEXT("1"));
	b_79.HasElectricityData = true; b_79.ElectricityInfo.CurrentObjectEnergy = 0.000000;
	b_79.HasRelationshipData = true; FGuid b_79_rel_id; FGuid::Parse("6EEA645949C55B8F90F421AB704204C1", b_79_rel_id); b_79.RelationshipInfo.ID = b_79_rel_id;
	FRelationshipInfo b_79_rel0; FGuid b_79_rel0_id; FGuid::Parse("A9F299C54AB0F2B6ABEBC280C23BF218", b_79_rel0_id); b_79_rel0.TargetID = b_79_rel0_id; b_79_rel0.RelationshipType = 1;
	b_79.RelationshipInfo.Relationships.Add(b_79_rel0);
	FRelationshipInfo b_79_rel1; FGuid b_79_rel1_id; FGuid::Parse("053D69F542E0BAEAD45D9D9ED75F3844", b_79_rel1_id); b_79_rel1.TargetID = b_79_rel1_id; b_79_rel1.RelationshipType = 1;
	b_79.RelationshipInfo.Relationships.Add(b_79_rel1); UsedBlocks->Add(b_79);
	c->PlayerPosition = FVector(-137, -365, 163);
	c->PlayerRotation = FRotator(0, 25, 0);
