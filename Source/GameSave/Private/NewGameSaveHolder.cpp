...
USaveGameCarrier* UNewGameSaveHolder::getTutorialGameSave(bool full)
{
	...
	auto b_6 = make1(700, 0, -35, 9, 7, 7, 11, 0, 90, 0, 10.000000, ""); af(b_6, TEXT("DoorOpening"), 0); bd(b_6, TEXT("DoorState"), TEXT("2")); bd(b_6, TEXT("DoorYaw"), TEXT("89.0")); mE(b_6, 0.000000); UsedBlocks->Add(b_6);
	...
	auto b_80 = make1(1200, 11, -10, 5, 3, 3, 3, 0, 0, 0, 10.000000, ""); mE(b_80, 100000.000000); UsedBlocks->Add(b_80);
	auto b_81 = make1(1, 3, -21, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_81, 0.000000); UsedBlocks->Add(b_81);
	auto b_82 = make1(1, -15, -21, 9, 1, 1, 11, 0, 90, 0, 110.000000, ""); mE(b_82, 0.000000); UsedBlocks->Add(b_82);
	auto b_83 = make1(600, -15, -30, 9, 17, 1, 11, 0, -90, 0, 1870.000000, ""); mE(b_83, 74800.000000); UsedBlocks->Add(b_83);
	auto b_84 = make1(2, 16, -12, 8, 6, 1, 7, 0, 90, 0, 420.000000, ""); UsedBlocks->Add(b_84);
	auto b_85 = make1(2, 14, -15, 8, 3, 1, 7, 0, 0, 0, 210.000000, ""); UsedBlocks->Add(b_85);
	auto b_86 = make1(2, 11, -15, 6, 3, 1, 4, 0, 0, 0, 120.000000, ""); UsedBlocks->Add(b_86);
	auto b_87 = make1(0, -26, -12, 1, 20, 20, 4, 0, 0, 0, 16000.000000, ""); mE(b_87, 0.000000); UsedBlocks->Add(b_87);
	auto b_88 = make1(0, -26, 8, 1, 20, 20, 4, 0, 0, 0, 16000.000000, ""); mE(b_88, 0.000000); UsedBlocks->Add(b_88);
	auto b_89 = make1(0, -5, 14, 1, 20, 10, 4, 0, -180, 0, 8000.000000, ""); mE(b_89, 0.000000); UsedBlocks->Add(b_89);
	auto b_90 = make1(0, 15, 14, 1, 20, 10, 4, 0, -180, 0, 8000.000000, ""); mE(b_90, 0.000000); UsedBlocks->Add(b_90);
	auto b_91 = make1(1150, 12, 6, 4, 9, 9, 2, 0, 0, 0, 1620.000000, ""); mE(b_91, 162000.000000); UsedBlocks->Add(b_91);
	auto b_92 = make1(2, 7, 6, 9, 9, 1, 10, 0, 90, 0, 900.000000, ""); UsedBlocks->Add(b_92);
	auto b_93 = make1(2, 12, 11, 9, 9, 1, 10, 0, 180, 0, 900.000000, ""); UsedBlocks->Add(b_93);
	auto b_94 = make1(2, 17, 6, 9, 9, 1, 10, 0, 90, 0, 900.000000, ""); UsedBlocks->Add(b_94);
	auto b_95 = make1(2, 12, 1, 9, 9, 1, 10, 0, -180, 0, 900.000000, ""); UsedBlocks->Add(b_95);
	auto b_96 = make1(2, 12, 6, 15, 9, 9, 1, 0, -90, 0, 810.000000, ""); UsedBlocks->Add(b_96);
	auto b_97 = make1(1, 23, -10, 9, 2, 1, 11, 0, 180, 0, 220.000000, ""); mE(b_97, 0.000000); UsedBlocks->Add(b_97);
	auto b_98 = make1(1, 24, 18, 9, 1, 1, 11, 0, -90, 0, 110.000000, ""); mE(b_98, 0.000000); UsedBlocks->Add(b_98);
	auto b_99 = make1(1, 24, 3, 9, 2, 1, 11, 0, 90, 0, 220.000000, ""); mE(b_99, 0.000000); UsedBlocks->Add(b_99);
	auto b_100 = make1(1, 4, 18, 9, 2, 1, 11, 0, 0, 0, 220.000000, ""); mE(b_100, 0.000000); UsedBlocks->Add(b_100);
	auto b_101 = make1(1, -4, -21, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_101, 0.000000); UsedBlocks->Add(b_101);
	auto b_102 = make1(1, -4, 18, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_102, 0.000000); UsedBlocks->Add(b_102);
	auto b_103 = make1(1, -4, -7, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_103, 0.000000); UsedBlocks->Add(b_103);
	auto b_104 = make1(1, -4, 1, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_104, 0.000000); UsedBlocks->Add(b_104);
	auto b_105 = make1(0, 15, -2, 1, 20, 20, 4, 0, 90, 0, 16000.000000, ""); mE(b_105, 0.000000); UsedBlocks->Add(b_105);
	auto b_106 = make1(1, -15, -7, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_106, 0.000000); UsedBlocks->Add(b_106);
	auto b_107 = make1(700, -7, -3, 9, 7, 7, 11, 0, 90, 0, 10.000000, ""); af(b_107, TEXT("DoorOpening"), 1); bd(b_107, TEXT("DoorState"), TEXT("0")); bd(b_107, TEXT("DoorYaw"), TEXT("0.0")); mE(b_107, 0.000000); UsedBlocks->Add(b_107);
	auto b_108 = make1(1, -35, -21, 9, 1, 1, 11, 0, -90, 0, 110.000000, ""); mE(b_108, 0.000000); UsedBlocks->Add(b_108);
	auto b_109 = make1(1, -35, 18, 9, 1, 1, 11, 0, -90, 0, 110.000000, ""); mE(b_109, 0.000000); UsedBlocks->Add(b_109);
	auto b_110 = make1(1, -35, -1, 9, 2, 1, 11, 0, -90, 0, 220.000000, ""); mE(b_110, 0.000000); UsedBlocks->Add(b_110);
	auto b_111 = make1(600, -25, -21, 9, 19, 1, 11, 0, 0, 0, 2090.000000, ""); mE(b_111, 83600.000000); UsedBlocks->Add(b_111);
	auto b_112 = make1(600, -35, -11, 9, 18, 1, 11, 0, -90, 0, 1980.000000, ""); mE(b_112, 79200.000000); UsedBlocks->Add(b_112);
	auto b_113 = make1(600, -25, 18, 9, 18, 1, 11, 0, -180, 0, 1980.000000, ""); mE(b_113, 79200.000000); UsedBlocks->Add(b_113);
	auto b_114 = make1(600, 0, 18, 9, 7, 1, 11, 0, -180, 0, 770.000000, ""); mE(b_114, 30800.000000); UsedBlocks->Add(b_114);
	auto b_115 = make1(600, 24, -4, 9, 12, 1, 11, 0, 90, 0, 1320.000000, ""); mE(b_115, 52800.000000); UsedBlocks->Add(b_115);
	auto b_116 = make1(600, 24, 11, 9, 13, 1, 11, 0, 90, 0, 1430.000000, ""); mE(b_116, 57200.000000); UsedBlocks->Add(b_116);
	auto b_117 = make1(1, -4, 10, 9, 1, 16, 11, 0, -180, 0, 1760.000000, ""); mE(b_117, 0.000000); UsedBlocks->Add(b_117);
	auto b_118 = make1(2, -10, -21, 9, 1, 10, 11, 0, -90, 0, 1100.000000, ""); UsedBlocks->Add(b_118);
	auto b_119 = make1(2, 0, -21, 9, 1, 6, 11, 0, 90, 0, 660.000000, ""); UsedBlocks->Add(b_119);
	auto b_120 = make1(2, -4, -14, 9, 1, 13, 11, 0, 180, 0, 1430.000000, ""); UsedBlocks->Add(b_120);
	auto b_121 = make1(1, -10, 9, 15, 1, 16, 11, 90, 0, 0, 1760.000000, ""); mE(b_121, 0.000000); UsedBlocks->Add(b_121);
	auto b_122 = make1(1, -10, 1, 9, 11, 2, 11, 0, 0, 0, 2420.000000, ""); mE(b_122, 0.000000); UsedBlocks->Add(b_122);
	auto b_123 = make1(1, -10, 18, 9, 11, 2, 11, 0, 180, 0, 2420.000000, ""); mE(b_123, 0.000000); UsedBlocks->Add(b_123);
	auto b_124 = make1(1, -16, 18, 9, 1, 1, 11, 0, 90, 0, 110.000000, ""); mE(b_124, 0.000000); UsedBlocks->Add(b_124);
	auto b_125 = make1(1, -16, 17, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_125, 0.000000); UsedBlocks->Add(b_125);
	auto b_126 = make1(1, -16, 16, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_126, 0.000000); UsedBlocks->Add(b_126);
	auto b_127 = make1(1, -16, 15, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_127, 0.000000); UsedBlocks->Add(b_127);
	auto b_128 = make1(1, -16, 14, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_128, 0.000000); UsedBlocks->Add(b_128);
	auto b_129 = make1(1, -16, 13, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_129, 0.000000); UsedBlocks->Add(b_129);
	auto b_130 = make1(1, -16, 12, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_130, 0.000000); UsedBlocks->Add(b_130);
	auto b_131 = make1(1, -16, 11, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_131, 0.000000); UsedBlocks->Add(b_131);
	auto b_132 = make1(1, -16, 10, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_132, 0.000000); UsedBlocks->Add(b_132);
	auto b_133 = make1(1, -16, 9, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_133, 0.000000); UsedBlocks->Add(b_133);
	auto b_134 = make1(2, -15, -3, 9, 7, 1, 11, 0, 90, 0, 770.000000, ""); UsedBlocks->Add(b_134);
	auto b_135 = make1(600, -35, 8, 9, 18, 1, 11, 0, 90, 0, 1980.000000, ""); mE(b_135, 79200.000000); UsedBlocks->Add(b_135);
	auto b_136 = make1(600, 15, 18, 9, 18, 1, 11, 0, 180, 0, 1980.000000, ""); mE(b_136, 79200.000000); UsedBlocks->Add(b_136);
