...
USaveGameCarrier* UNewGameSaveHolder::getDefaultGameSave(bool full)
{
	...
	auto b_86 = make(1400, FVector(22, -10, 5), FVector(4, 3, 4), FRotator(0, 90, 0), 1400, "Plnicka"); b_86.HasElectricityData = true; b_86.ElectricityInfo.CurrentObjectEnergy = 150.000000; b_86.HasOxygenData = true; b_86.OxygenInfo.CurrentObjectOxygen = 0.000000;
	...
	c->PlayerPosition = FVector(150, -135, 197);
