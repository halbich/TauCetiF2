...
USaveGameCarrier* UNewGameSaveHolder::getTutorialGameSave(bool full)
{
	...
	auto b_11 = make1(1, 3, -31, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_11, 0.000000); UsedBlocks->Add(b_11);
	auto b_12 = make1(1150, -12, 2, 4, 3, 3, 2, 0, 0, 0, 180.000000, ""); mE(b_12, 18000.000000); UsedBlocks->Add(b_12);
	auto b_13 = make1(1150, -12, -1, 4, 3, 3, 2, 0, 0, 0, 180.000000, ""); mE(b_13, 18000.000000); UsedBlocks->Add(b_13);
	auto b_14 = make1(1150, -9, 2, 4, 3, 3, 2, 0, 0, 0, 180.000000, ""); mE(b_14, 18000.000000); UsedBlocks->Add(b_14);
	auto b_15 = make1(1150, -9, -1, 4, 3, 3, 2, 0, 0, 0, 180.000000, ""); mE(b_15, 18000.000000); UsedBlocks->Add(b_15);
	auto b_16 = make1(1150, -12, -4, 4, 3, 3, 2, 0, -180, 0, 180.000000, ""); mE(b_16, 18000.000000); UsedBlocks->Add(b_16);
	auto b_17 = make1(1150, -9, -4, 4, 3, 3, 2, 0, -180, 0, 180.000000, ""); mE(b_17, 18000.000000); UsedBlocks->Add(b_17);
	auto b_18 = make1(1150, -6, 2, 4, 3, 3, 2, 0, -180, 0, 180.000000, ""); mE(b_18, 18000.000000); UsedBlocks->Add(b_18);
	auto b_19 = make1(1150, -6, -1, 4, 3, 3, 2, 0, -180, 0, 180.000000, ""); mE(b_19, 18000.000000); UsedBlocks->Add(b_19);
	auto b_20 = make1(1150, -6, -4, 4, 3, 3, 2, 0, -180, 0, 180.000000, ""); mE(b_20, 18000.000000); UsedBlocks->Add(b_20);
	auto b_21 = make1(0, -6, 14, 1, 20, 12, 4, 0, 0, 0, 9600.000000, ""); mE(b_21, 0.000000); UsedBlocks->Add(b_21);
	auto b_22 = make1(0, 14, 14, 1, 20, 12, 4, 0, 0, 0, 9600.000000, ""); mE(b_22, 0.000000); UsedBlocks->Add(b_22);
	auto b_23 = make1(2, -9, 4, 9, 11, 1, 9, 90, 0, -180, 990.000000, ""); UsedBlocks->Add(b_23);
	auto b_24 = make1(2, -9, -6, 9, 11, 1, 9, 90, 0, 0, 990.000000, ""); UsedBlocks->Add(b_24);
	auto b_25 = make1(2, -14, -1, 9, 11, 1, 9, 90, 0, 90, 990.000000, ""); UsedBlocks->Add(b_25);
	auto b_26 = make1(2, -4, -1, 9, 11, 1, 9, 90, 0, 90, 990.000000, ""); UsedBlocks->Add(b_26);
	auto b_27 = make1(2, -9, -1, 15, 11, 1, 11, 0, 90, 90, 1210.000000, ""); UsedBlocks->Add(b_27);
	auto b_28 = make1(1, 24, 6, 13, 8, 1, 2, 90, 0, 90, 160.000000, ""); mE(b_28, 0.000000); UsedBlocks->Add(b_28);
	auto b_29 = make1(1, 24, 20, 10, 1, 1, 14, 0, 0, 0, 140.000000, ""); mE(b_29, 0.000000); UsedBlocks->Add(b_29);
	auto b_30 = make1(1, -15, 20, 10, 1, 1, 14, 0, 0, 0, 140.000000, ""); mE(b_30, 0.000000); UsedBlocks->Add(b_30);
	auto b_31 = make1(600, 15, 20, 9, 18, 1, 11, 0, -180, 0, 1980.000000, ""); mE(b_31, 79200.000000); UsedBlocks->Add(b_31);
	auto b_32 = make1(600, -5, 20, 9, 18, 1, 11, 0, -180, 0, 1980.000000, ""); mE(b_32, 79200.000000); UsedBlocks->Add(b_32);
	auto b_33 = make1(1, 5, 20, 10, 1, 1, 14, 0, 90, 0, 140.000000, ""); mE(b_33, 0.000000); UsedBlocks->Add(b_33);
	auto b_34 = make1(1, 4, 20, 10, 1, 1, 14, 0, 90, 0, 140.000000, ""); mE(b_34, 0.000000); UsedBlocks->Add(b_34);
	auto b_35 = make1(600, 24, 14, 9, 11, 1, 11, 0, -90, 0, 1210.000000, ""); mE(b_35, 48400.000000); UsedBlocks->Add(b_35);
	auto b_36 = make1(1, 24, 13, 16, 12, 1, 3, 0, 90, 0, 360.000000, ""); mE(b_36, 0.000000); UsedBlocks->Add(b_36);
	auto b_37 = make1(1000, 23, 7, 17, 1, 1, 1, 0, 90, -180, 10.000000, ""); mE(b_37, 2000.000000); mEP(b_37, 1, 1, 1.000000);
	mr(b_37, "886E9EFB4E8995200EFA2FB3DC24CB8A"); UsedBlocks->Add(b_37);
	auto b_38 = make1(1, 24, -31, 9, 1, 1, 11, 0, 0, 0, 110.000000, ""); mE(b_38, 0.000000); UsedBlocks->Add(b_38);
	auto b_39 = make1(2, 13, -31, 9, 20, 1, 11, 0, 0, 0, 2200.000000, ""); UsedBlocks->Add(b_39);
	auto b_40 = make1(2, 24, -20, 5, 20, 1, 3, 0, -90, 0, 600.000000, ""); UsedBlocks->Add(b_40);
	auto b_41 = make1(2, 24, -20, 13, 20, 1, 3, 0, -90, 0, 600.000000, ""); UsedBlocks->Add(b_41);
	auto b_42 = make1(1, 24, -14, 11, 1, 1, 3, 0, -180, 90, 30.000000, ""); mE(b_42, 0.000000); UsedBlocks->Add(b_42);
	auto b_43 = make1(1, 24, -18, 11, 1, 1, 3, 0, -180, 90, 30.000000, ""); mE(b_43, 0.000000); UsedBlocks->Add(b_43);
	auto b_44 = make1(1, 24, -22, 11, 1, 1, 3, 0, -180, 90, 30.000000, ""); mE(b_44, 0.000000); UsedBlocks->Add(b_44);
	auto b_45 = make1(1, 24, -26, 9, 1, 1, 5, 0, 180, 0, 50.000000, ""); mE(b_45, 0.000000); UsedBlocks->Add(b_45);
	auto b_46 = make1(1, 24, -28, 9, 1, 1, 5, 0, 180, 0, 50.000000, ""); mE(b_46, 0.000000); UsedBlocks->Add(b_46);
	auto b_47 = make1(1, 24, -14, 8, 1, 1, 4, 0, 180, 0, 40.000000, ""); mE(b_47, 0.000000); UsedBlocks->Add(b_47);
	auto b_48 = make1(1, 24, -17, 9, 1, 1, 3, 0, 180, 0, 30.000000, ""); mE(b_48, 0.000000); UsedBlocks->Add(b_48);
	auto b_49 = make1(1, 24, -21, 8, 1, 1, 4, 0, 180, 0, 40.000000, ""); mE(b_49, 0.000000); UsedBlocks->Add(b_49);
	auto b_50 = make1(1, 24, -18, 7, 1, 1, 3, 0, 180, 90, 30.000000, ""); mE(b_50, 0.000000); UsedBlocks->Add(b_50);
	auto b_51 = make1(1, 24, -19, 10, 1, 1, 1, 0, -180, 0, 10.000000, ""); mE(b_51, 0.000000); UsedBlocks->Add(b_51);
	auto b_52 = make1(1, 24, -19, 8, 1, 1, 1, 0, -180, 0, 10.000000, ""); mE(b_52, 0.000000); UsedBlocks->Add(b_52);
	auto b_53 = make1(1, 24, -22, 9, 1, 1, 2, 0, 180, 90, 20.000000, ""); mE(b_53, 0.000000); UsedBlocks->Add(b_53);
	auto b_54 = make1(1, 24, -10, 9, 1, 1, 11, 0, -180, 0, 110.000000, ""); mE(b_54, 0.000000); UsedBlocks->Add(b_54);
	auto b_55 = make1(2, 24, -30, 9, 1, 2, 5, 0, 0, 0, 100.000000, ""); UsedBlocks->Add(b_55);
	auto b_56 = make1(2, 24, -12, 9, 1, 2, 5, 0, 0, 0, 100.000000, ""); UsedBlocks->Add(b_56);
	auto b_57 = make1(2, 24, -16, 9, 1, 1, 5, 0, -180, 0, 50.000000, ""); UsedBlocks->Add(b_57);
	auto b_58 = make1(2, 24, -20, 9, 1, 1, 5, 0, -180, 0, 50.000000, ""); UsedBlocks->Add(b_58);
	auto b_59 = make1(2, 24, -27, 9, 1, 1, 5, 0, -180, 0, 50.000000, ""); UsedBlocks->Add(b_59);
	auto b_60 = make1(2, 24, -24, 9, 1, 2, 5, 0, 180, 0, 100.000000, ""); UsedBlocks->Add(b_60);
	auto b_61 = make1(2, 24, -13, 8, 1, 1, 4, 0, -90, 0, 40.000000, ""); UsedBlocks->Add(b_61);
	auto b_62 = make1(2, 24, -15, 8, 1, 1, 4, 0, -90, 0, 40.000000, ""); UsedBlocks->Add(b_62);
	auto b_63 = make1(2, 24, -18, 9, 1, 1, 3, 0, 180, 0, 30.000000, ""); UsedBlocks->Add(b_63);
	auto b_64 = make1(2, 24, -23, 10, 1, 1, 2, 0, -180, -90, 20.000000, ""); UsedBlocks->Add(b_64);
	auto b_65 = make1(2, 24, -22, 7, 1, 1, 2, 0, -180, 0, 20.000000, ""); UsedBlocks->Add(b_65);
	auto b_66 = make1(2, 24, -23, 7, 1, 1, 2, 0, -180, 0, 20.000000, ""); UsedBlocks->Add(b_66);
	auto b_67 = make1(2, 24, -19, 9, 1, 1, 1, 0, -180, 0, 10.000000, ""); UsedBlocks->Add(b_67);
	auto b_68 = make1(1, -15, -39, 9, 1, 1, 11, 0, 180, 0, 110.000000, ""); mE(b_68, 0.000000); mEP(b_68, 1, 1, 1.000000); UsedBlocks->Add(b_68);
	auto b_69 = make1(1000, 23, -30, 4, 1, 1, 1, 0, 90, 0, 10.000000, ""); mE(b_69, 2000.000000); mEP(b_69, 1, 1, 1.000000);
	mr(b_69, "97CF1EDB4D942B960C31B5A6AF7B17E6"); UsedBlocks->Add(b_69);
	auto b_70 = make1(1000, 23, -11, 4, 1, 1, 1, 0, 90, 0, 10.000000, ""); mE(b_70, 2000.000000); mEP(b_70, 1, 1, 1.000000);
	mr(b_70, "24CDB92B4512372CBCCAA9842D3C73FD"); UsedBlocks->Add(b_70);
	auto b_71 = make1(1, 22, -20, 9, 1, 20, 11, 0, 180, 0, 2200.000000, ""); mE(b_71, 0.000000); mEP(b_71, 1, 1, 1.000000); UsedBlocks->Add(b_71);
	auto b_72 = make1(500, 21, -21, 11, 1, 8, 5, 0, 0, 0, 10.000000, ""); mE(b_72, 100000.000000); UsedBlocks->Add(b_72);
	auto b_73 = make1(101, 21, -20, 8, 8, 1, 1, 0, -90, 180, 26.666668, ""); mE(b_73, 0.000000); UsedBlocks->Add(b_73);
	auto b_74 = make1(1150, 14, -13, 4, 3, 3, 2, 0, -180, 0, 180.000000, ""); mE(b_74, 18000.000000); UsedBlocks->Add(b_74);
	auto b_75 = make1(1150, 11, -13, 4, 3, 3, 2, 0, -180, 0, 180.000000, ""); mE(b_75, 18000.000000); UsedBlocks->Add(b_75);
	auto b_76 = make1(1150, 14, -10, 4, 3, 3, 2, 0, -180, 0, 180.000000, ""); mE(b_76, 18000.000000); UsedBlocks->Add(b_76);
	auto b_77 = make1(1, 9, -12, 4, 6, 1, 1, 0, 90, 0, 60.000000, ""); mE(b_77, 0.000000); UsedBlocks->Add(b_77);
	auto b_78 = make1(1, 12, -15, 4, 6, 1, 1, 0, 0, 0, 60.000000, ""); mE(b_78, 0.000000); UsedBlocks->Add(b_78);
	auto b_79 = make1(1, 16, -11, 4, 6, 1, 1, 0, -90, 0, 60.000000, ""); mE(b_79, 0.000000); UsedBlocks->Add(b_79);
	auto b_80 = make1(1, 13, -8, 4, 6, 1, 1, 0, 180, 0, 60.000000, ""); mE(b_80, 0.000000); UsedBlocks->Add(b_80);
	auto b_81 = make1(101, 8, -12, 4, 8, 1, 1, 0, 90, 0, 26.666668, ""); mE(b_81, 0.000000); UsedBlocks->Add(b_81);
	auto b_82 = make1(101, 13, -16, 4, 8, 1, 1, 0, 180, 0, 26.666668, ""); mE(b_82, 0.000000); UsedBlocks->Add(b_82);
	auto b_83 = make1(101, 17, -11, 4, 8, 1, 1, 0, -90, 0, 26.666668, ""); mE(b_83, 0.000000); UsedBlocks->Add(b_83);
	auto b_84 = make1(101, 12, -7, 4, 8, 1, 1, 0, 0, 0, 26.666668, ""); mE(b_84, 0.000000); UsedBlocks->Add(b_84);
	auto b_85 = make1(201, 8, -7, 4, 1, 1, 1, 0, 90, 0, 5.000000, ""); mE(b_85, 0.000000); UsedBlocks->Add(b_85);
	auto b_86 = make1(201, 8, -16, 4, 1, 1, 1, 0, 180, 0, 5.000000, ""); mE(b_86, 0.000000); UsedBlocks->Add(b_86);
	auto b_87 = make1(201, 17, -16, 4, 1, 1, 1, 0, -90, 0, 5.000000, ""); mE(b_87, 0.000000); UsedBlocks->Add(b_87);
	auto b_88 = make1(201, 17, -7, 4, 1, 1, 1, 0, 0, 0, 5.000000, ""); mE(b_88, 0.000000); UsedBlocks->Add(b_88);
	auto b_89 = make1(1, 9, -8, 4, 1, 1, 1, 0, -90, 0, 10.000000, ""); mE(b_89, 0.000000); UsedBlocks->Add(b_89);
	auto b_90 = make1(1, 16, -8, 4, 1, 1, 1, 0, -90, 0, 10.000000, ""); mE(b_90, 0.000000); UsedBlocks->Add(b_90);
	auto b_91 = make1(1, 16, -15, 4, 1, 1, 1, 0, -90, 0, 10.000000, ""); mE(b_91, 0.000000); UsedBlocks->Add(b_91);
	auto b_92 = make1(1, 9, -15, 4, 1, 1, 1, 0, -90, 0, 10.000000, ""); mE(b_92, 0.000000); UsedBlocks->Add(b_92);
	auto b_93 = make1(101, 16, -15, 8, 7, 1, 1, 90, -90, 90, 23.333334, ""); mE(b_93, 0.000000); UsedBlocks->Add(b_93);
	auto b_94 = make1(101, 9, -15, 8, 7, 1, 1, 90, 0, -90, 23.333334, ""); mE(b_94, 0.000000); UsedBlocks->Add(b_94);
	auto b_95 = make1(101, 9, -8, 8, 7, 1, 1, 90, 0, 0, 23.333334, ""); mE(b_95, 0.000000); UsedBlocks->Add(b_95);
	auto b_96 = make1(101, 16, -8, 8, 7, 1, 1, 90, 0, 90, 23.333334, ""); mE(b_96, 0.000000); UsedBlocks->Add(b_96);
	auto b_97 = make1(201, 16, -8, 12, 1, 1, 1, 0, 0, 0, 5.000000, ""); mE(b_97, 0.000000); UsedBlocks->Add(b_97);
	auto b_98 = make1(201, 9, -8, 12, 1, 1, 1, 0, 90, 0, 5.000000, ""); mE(b_98, 0.000000); UsedBlocks->Add(b_98);
	auto b_99 = make1(201, 9, -15, 12, 1, 1, 1, 0, -180, 0, 5.000000, ""); mE(b_99, 0.000000); UsedBlocks->Add(b_99);
	auto b_100 = make1(201, 16, -15, 12, 1, 1, 1, 0, -90, 0, 5.000000, ""); mE(b_100, 0.000000); UsedBlocks->Add(b_100);
	auto b_101 = make1(101, 12, -15, 12, 6, 1, 1, 0, 0, -90, 20.000000, ""); mE(b_101, 0.000000); UsedBlocks->Add(b_101);
	auto b_102 = make1(101, 16, -11, 12, 6, 1, 1, 0, -90, 0, 20.000000, ""); mE(b_102, 0.000000); UsedBlocks->Add(b_102);
	auto b_103 = make1(101, 12, -8, 12, 6, 1, 1, 0, 0, 0, 20.000000, ""); mE(b_103, 0.000000); UsedBlocks->Add(b_103);
	auto b_104 = make1(101, 9, -12, 12, 6, 1, 1, 0, 90, 0, 20.000000, ""); mE(b_104, 0.000000); UsedBlocks->Add(b_104);
	auto b_105 = make1(2, 13, -12, 12, 6, 6, 1, 0, 90, 0, 360.000000, ""); UsedBlocks->Add(b_105);
	auto b_106 = make1(2, 12, -28, 4, 6, 6, 1, 0, 0, 0, 360.000000, ""); UsedBlocks->Add(b_106);
	auto b_107 = make1(2, 12, -28, 5, 6, 6, 1, 0, 0, 0, 360.000000, ""); UsedBlocks->Add(b_107);
	auto b_108 = make1(2, 12, -28, 6, 6, 6, 1, 0, 0, 0, 360.000000, ""); UsedBlocks->Add(b_108);
	auto b_109 = make1(2, 12, -8, 8, 6, 1, 7, 0, 0, 0, 420.000000, ""); UsedBlocks->Add(b_109);
	auto b_110 = make1(1200, 11, -10, 5, 3, 3, 3, 0, 0, 0, 10.000000, ""); mE(b_110, 100000.000000); UsedBlocks->Add(b_110);

	c->PlayerPosition = FVector(1172, -841, 82);
	c->PlayerRotation = FRotator(0, 168, 0);
	c->PlayerCameraRotation = FRotator(2.978605, 168.122406, 0.0);
