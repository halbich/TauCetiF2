...
USaveGameCarrier* UNewGameSaveHolder::getTutorialGameSave(bool full)
{
	...
	auto b_6 = make1(700, 0, -35, 9, 7, 7, 11, 0, 90, 0, 10.000000, ""); af(b_6, TEXT("DoorOpening"), 0); bd(b_6, TEXT("DoorState"), TEXT("0")); bd(b_6, TEXT("DoorYaw"), TEXT("0")); mE(b_6, 0.000000); UsedBlocks->Add(b_6);
